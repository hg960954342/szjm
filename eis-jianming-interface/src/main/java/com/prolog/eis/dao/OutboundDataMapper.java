...
public interface OutboundDataMapper {
    ...
    @Insert("insert into outbound_task (bill_no,wms_push,reback,empty_container,task_type,sfreq,pick_code,owner_id,create_time) " +
            "values(#{billNo},#{wmsPush},#{reBack},#{emptyContainer},#{taskType},#{sfReq},#{pickCode},#{ownerId},#{createTime})")
    ...
    @Insert("insert into outbound_task (bill_no,wms_push,reback,empty_container,task_type,create_time) values (#{billNo},#{wmsPush},#{reBack},#{emptyContainer},#{taskType},#{createTime})")
    ...
    @Insert("insert into outbound_task (bill_no,wms_push,reback,empty_container,task_type,pick_code,create_time) values (#{billNo},#{wmsPush},#{reBack},#{emptyContainer},#{taskType},#{pickCode},#{createTime})")
