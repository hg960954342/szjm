...
public class GcsTask {
	...
	@Column("task_type")
	@ApiModelProperty("任务类型：1:入库 2:出库 3:搬运,4:小车跨层")
	...
	public GcsTask(String id, String stockId, String taskId, int layer, int taskType, int priority, String locIdFrom,
