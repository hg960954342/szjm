 ...
 * 订单出库 未指定拣选站
 */
@Component(OutBoundType.TASK_TYPE+1+OutBoundType.IF_SfReq+100)
@Slf4j
@SuppressWarnings("all")
public class OrderBoundStrategy2 extends DefaultOutBoundPickCodeStrategy {
    ...
    public void unbound(OutboundTask outboundTask) {
        ...
        int randomElementIndex
                = ThreadLocalRandom.current().nextInt(lists.size()) % lists.size();
