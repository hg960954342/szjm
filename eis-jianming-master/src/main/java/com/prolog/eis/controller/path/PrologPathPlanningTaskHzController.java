...
@RestController
@Api(tags = "路径规划任务汇总")
@RequestMapping("/api/v1/sxk/pathplanningtaskhz")
public class PrologPathPlanningTaskHzController {
    ...
    {
        return "id,startLocation,targetLocation,pathType,msg,containerNo,createTime";
    }
    
    private String getTableName()
    {
        return "sxpathplanningtaskhzview";
    }*/
}
