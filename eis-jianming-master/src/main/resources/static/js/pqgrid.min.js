...
(function (k) {
    ...
    h.xmlToArray = function (h, g) {
        var e = g.itemParent, c = g.itemNames, f = [];
    ...
    h.tableToArray = function (h) {
        ...
        var c = h.length ? k(h[0]) : k(), f = 1 < h.length ? k(h[1]) : k();
        c.children("th,td").each(function (b, c) {
            var a = k(c), d = a.html(), a = a.width(), n = "left";
            if (f.length) var N = f.find("td:eq(" + b + ")").attr("align"), n = N ? N : n;
            g.push({title: d, width: a, dataType: "string", align: n, dataIndx: b})
        });
        h.each(function (b, c) {
            if (0 != b) {
                var a = [];
        ...
        return {data: e, colModel: g}
    };
    h.formatCurrency = function (h) {
        if (isNaN(h)) return h;
        h = Math.round(100 * h) / 100;
        h += "";
        -1 == h.indexOf(".") ? h += ".00" : h.indexOf(".") + 2 == h.length && (h += "0");
        var g = h.length, e = h.substring(0, g - 3);
        h = h.substring(g - 3, g);
...
(function (k) {
    ...
    h._onChange = function (h, g) {
        if (!1 === this._trigger("beforeChange", h, {curPage: g}) || !1 === this._trigger("change", h, {curPage: g})) return !1;
        this.option({curPage: g})
    };
    h._refresh = function () {
        this._refreshPage();
        var h = this, g = this.options;
        ...
        if (g.strRpp) {
            ...
            this.$rPP = k(c).appendTo(this.rPPHolder).filter("select").val(g.rPP).change(function (a) {
                var n =
                    k(this), b = n.val();
                if (!1 === h._trigger("beforeChange", a, {rPP: b})) return n.val(h.options.rPP), !1;
                !1 !== h._trigger("change", a, {rPP: b}) && (h.options.rPP = b)
            })
        }
        g.curPage >= g.totalPages ? (this.next.button({disabled: !0}), this.last.button({disabled: !0})) : (this.next.button({disabled: !1}), this.last.button({disabled: !1}));
        1 >= g.curPage ? (this.first.button({disabled: !0}), this.prev.button({disabled: !0})) : (this.first.button({disabled: !1}), this.prev.button({disabled: !1}));
    ...
    k.widget("paramquery.pqScrollBar", {
        options: {
            ...
            var h = this, m = this.options,
                g = m.direction, e = this.eventNamespace, c = m.theme, f = this.element.empty();
            ...
            f.disableSelection().unbind(".pq-scrollbar").on("mousedown.pq-scrollbar", function (b) {
                if (!m.disabled && !h.$slider.is(":hidden")) if (k(document).off("." +
                    e).on("mouseup." + e, function (a) {
                    h._mouseup(a)
                }), "vertical" == g) {
                    var c = b.pageY, a = h.element.offset().top, d = a + m.length, n = h.$slider, N = n.offset().top,
                        B = n.height(), f = N + B;
                    ...
                    var v =
                            b.pageX, a = h.element.offset().left, d = a + m.length, N = h.$slider.offset().left,
                        f = N + h.$slider.width();
            ...
            h.draggable({
                ...
                var c = e.keyCode, f = m.options, b = f.cur_pos, l = f.ratio, a = f.num_eles, d = k.ui.keyCode;
            ...
            var k = this.options;
            if (k.steps) 0 < k.cur_pos && (k.cur_pos--, this.updateSliderPos(), this.scroll(h)); else if (0 < k.ratio) {
            ...
            var k = this.options;
            if (k.steps) k.cur_pos < k.num_eles - 1 && k.cur_pos++, this.updateSliderPos(), this.scroll(h); else {
                if (1 > k.ratio) {
                    var g = k.ratio + 1 / (k.num_eles - 1);
                    1 < g && (g = 1);
                    k.ratio = g
            ...
            if ("vertical" ==
                h.direction) {
                var k = this.element.offset().top + 17, h = k + h.length - 34 - this.slider_length;
            ...
            var h = this.options, k = this.element;
            ...
            var h = this.options, m = h.theme, g = this.$slider, e = h.length,
                e = Math.round(((e - 34) * e / (40 * h.num_eles + e) - 14) / 2);
            1 > e && (e = 1);
            var c = 14 + 2 * e;
            this.scroll_space = h.length - 34 - c;
            if (c !== this.slider_length) if (this.slider_length = c, h = "vertical" === h.direction ? {
                dim: "height",
                cls: ".vert-slider-bg"
            } : {dim: "width", cls: ".horiz-slider-bg"}, m) g[h.dim](c - 2); else k(h.cls, this.element)[h.dim](e),
                g[h.dim](c)
        }, _updateCurPosAndTrigger: function (h, k) {
            var g = this.options, e = g.direction, c = this.$slider;
            ...
            var k = this, g = this.options.direction;
            ...
            var h = this.options, k = h.direction, g = h.ratio, e = this.$slider,
            ...
            var h = this.options, k = this.scroll_space * h.cur_pos / (h.num_eles - 1);
            ...
            var k = this.options;
            this._trigger("scroll", h, {cur_pos: k.cur_pos, num_eles: k.num_eles})
        }, drag: function (h) {
            this._trigger("drag", h, {ratio: this.options.ratio})
...
(function (k) {
    ...
    h.generateView = function (a) {
        var d = this.that, n = d.options, b = n.freezeCols, c = "flex" === n.width, f = "flex" === n.height,
            e = d.colModel, g, h, x = d.initH, p = d.finalH, q = n.groupModel, t = d.pqpanes;
        if (a) {
            var m = this._generateTables(null, null, a), q = a.$cont;
            q.empty();
            ...
            var y = q.children("div"), f = y.children("table"), m = d.iRefresh, c = c ? "" : m.getEContWd(),
                m = f[0].scrollHeight - 1;
            q.height(m);
            if (t.v) {
                var t = k(y[0]), q = k(y[1]), y = k(f[1]), u = l.call(d, -1, b), b = l.call(d, b, x);
                t.css({width: u, zIndex: 1});
                q.css({left: u - 1, width: c - u, height: m});
                y.css({left: -1 * (b + u)})
            } else y.css({width: c, height: m});
            d.tables || (d.tables = []);
            b = -1;
            for (t = 0; t < d.tables.length; t++) d.tables[t].cont == a.$cont[0] && (b = t);
            -1 == b ? d.tables.push({$tbl: f, cont: a.$cont[0]}) : d.tables[b].$tbl = f
        } else {
            g = d.initV;
            h = d.finalV;
            var A = q ? d.dataGM : d.pdata, q = d.$cont;
            null != n.editModel.indices && d.blurEditor({force: !0});
            ...
            0 === d.totalVisibleRows ? q.append("<div class='pq-grid-cont-inner pq-grid-norows' >" + n.strNoRows + "</div>") : (b = f || c ? "style='position:relative;'" : "", q[0].innerHTML = t.h && t.v ? ["<div class='pq-grid-cont-inner'>", m, "</div><div class='pq-grid-cont-inner'>",
                m, "</div><div class='pq-grid-cont-inner'>", m, "</div><div class='pq-grid-cont-inner'>", m, "</div>"].join("") : t.v ? ["<div class='pq-grid-cont-inner' ", b, " >", m, "</div><div class='pq-grid-cont-inner' >", m, "</div>"].join("") : t.h ? ["<div class='pq-grid-cont-inner' style='position:static;' >", m, "</div><div class='pq-grid-cont-inner' style='position:static;' >", m, "</div>"].join("") : ["<div class='pq-grid-cont-inner' ", b, " >", m, "</div>"].join(""));
    ...
    h.scrollView =
        function () {
            var a = this.that, d = this.options, n = d.virtualXHeader, b = d.virtualY;
    ...
    h.setPaneEvents = function () {
        var a = this.that, d = a.pqpanes, n = a.$cont.children("div"), b = a.iMouseSelection;
        if ((a = a.$tbl) && a.length) if (d.h && d.v) {
            var d = k(n[0]), a = k(n[1]), c = k(n[2]), n = k(n[3]);
    ...
    h.setPanes = function () {
        var a = this.that, d = a.pqpanes, n = a.$cont.children("div"), b = a.iRefresh, c = a.$tbl, f = a.options,
            e = parseInt(f.freezeCols), g = a.initH;
        if (c && c.length) {
            var h = "flex" === f.width, f = "flex" === f.height ?
                "" : b.getEContHt(), b = h ? "" : b.getEContWd();
            if (d.h && d.v) {
                var g = k(n[0]), d = k(n[1]), h = k(c[1]), x = k(n[2]), p = k(c[2]), n = k(n[3]), q = k(c[3]),
                    c = l.call(a, -1, e), a = a.calcHeightFrozenRows(), e = a - 1;
                g.css({width: c, height: e});
                d.css({left: c, width: b - c, height: e});
                h.css({left: -1 * c});
                x.css({width: c, top: e, height: f - e});
                p.css({marginTop: -a});
                n.css({left: c, width: b - c, top: e, height: f - e});
                q.css({marginTop: -a, left: -1 * c})
                ...
                left: c,
                width: b - c, height: f
            }), h.css({left: -1 * (a + c)})) : d.h ? (g = k(n[0]), n = k(n[1]), c = k(c[1]), a = a.calcHeightFrozenRows(), e = a - 1, g.css({
                height: e,
                width: b
            }), n.css({width: b, top: e, height: f - e}), c.css({marginTop: -a})) : n.css({width: b, height: f})
        }
    };
    h._generateTables = function (a, d, n) {
        var b = this.that, c = b.colModel, f = b.options, e = f.virtualX, l = b.initH, g = b.finalH, h = f.numberCell,
            k = f.columnBorders, q = f.rowBorders, t = f.wrap, m = f.groupModel, y = f.freezeCols,
            f = parseInt(f.freezeRows), u = !1, A = 0, C = n ? n.data.length - 1 : d, D = m ? !0 : !1,
            E = n && n.data ? n.data :
                D ? b.dataGM : b.pdata, G = b.rowIndxOffset;
        n || b._trigger("beforeTableView", null, {pageData: E, initV: a, finalV: d, initH: l, finalH: g, colModel: c});
        if (n || null != a && null != C) {
            u = "pq-grid-table ";
    ...
    h._renderCell =
        function (a, d) {
            var n = this.options, b = a.rowData, c = a.column, f = c.type, c = c.dataIndx, e = b[c];
            if (b) {
    ...
    h.renderCell = function (a) {
        var d = this.that, n = this.options, b = a.rowData, c = a.rowIndx, f = a.rowIndxPage, e = a.column,
            l = a.colIndx, g = e.dataIndx, h = n.freezeCols, k = n.columnBorders, q = "pq-col-indx='" + l + "'", m = !1,
            w = "pq-grid-cell ";
        ...
        if (b = b.pq_cellattr) if (g = b[g]) for (var u in g) b = g[u], "title" == u && (b = b.replace(/\"/g, "&quot;")), q += " " + u + '="' + b + '"';
        return ["<td class='", w, "' ", q, " >", this._renderCell(a,
            y), "</td>"].join("")
    };
    h.refreshRow = function (a, d, n) {
        var b = this.that, c = b.pdata[a];
    ...
    h.options = {
        ...
        colModel: null,
        columnBorders: !0,
        dataModel: {cache: !1, dataType: "JSON", location: "local", sorting: "local", sortDir: "up", method: "GET"},
        direction: "",
        draggable: !1,
        editable: !0,
        editModel: {
        ...
        roundCorners: !0,
        rowBorders: !0,
        scrollModel: {pace: "fast", horizontal: !0, lastColumn: "auto", autoFit: !1, theme: !1},
        selectionModel: {fireSelectChange: !1, type: "cell", mode: "block"},
    ...
    h.collapse = function (a) {
        var d = this, n = this.element, b = this.options.collapsible, c = b.$collapse.children("span"),
            f = function () {
        ...
        !1 === a.animate ? (n.height(23), f()) : (b.animating = !0, n.animate({height: "23px"}, function () {
            f()
        }))
    };
    h.expand = function (a) {
        var d = this, n = this.element, b = this.options.collapsible, c = b.htCapture, f = b.$collapse.children("span"),
            e = function () {
                n.css("overflow", "");
                b._collapsed = !1;
                b.collapsed = !1;
        ...
        !1 === a.animate ? (n.height(c), e()) : (b.animating = !0, n.animate({height: c}, function () {
            e()
        }))
    };
    h._createCollapse = function () {
        var a = this, d = this.$top, n = this.options.collapsible;
    ...
    h._create = function () {
        ...
        d.collapsible || (d.collapsible = {on: !1, collapsed: !1});
    ...
    h.toggle = function () {
        var a = this.options, d = a.collapsible, n = this.element, b;
        b = k(document.body);
        "fixed" == n.css("position") ? (a = this.maxim.eleObj, d = this.maxim.docObj, this.option({
            height: a.height,
            width: a.width
        }), n.css({
            position: a.position, left: a.left, top: a.top, margin: a.margin,
            zIndex: a.zIndex
        }), b.css({
            height: d.height,
            width: d.width,
            overflow: d.overflow
        }), k("html").css({overflow: "visible"}), window.scrollTo(d.scrollLeft, d.scrollTop), b = "min") : (a = {
            height: a.height,
            width: a.width,
            ...
            margin: n.css("margin"),
            zIndex: n.css("zIndex")
        }, this.option({height: "100%-2", width: "100%-2"}), n.css(k.extend({
            position: "fixed",
            left: 0,
            top: 0,
            margin: 0
        }, d.css)), d = {
            height: b.height(), width: b.width(), overflow: b.css("overflow"), scrollLeft: k(window).scrollLeft(),
            scrollTop: k(window).scrollTop()
        }, k(document.body).css({
            height: 0,
            width: 0,
            overflow: "hidden"
        }), k("html").css({overflow: "hidden"}), window.scrollTo(0, 0), this.maxim = {eleObj: a, docObj: d}, b = "max");
        this._trigger("toggle", null, {state: b});
        this._refreshResizable();
        this.refresh();
        k(window).trigger("resize", {$grid: n, state: b})
    };
    ...
    h._saveDims = function () {
        ...
        if (a = this.$tbl_header) for (d = 0; d < a.length; d++) n = a[d], b = k(n).parent(), b.data("offsetHeight", Math.round(n.offsetHeight)), b.data("scrollWidth", Math.round(n.scrollWidth))
    };
    ...
    h._mouseDown = function (a) {
        ...
        if (k(a.target).closest(".pq-editor-focus").length) this._blurEditMode = !0, window.setTimeout(function () {
            d._blurEditMode = !1
        }, 0); else return this._saveDims(), this._mousePQUpDelegate = function (a) {
    ...
    h.onWindowResize = function (a, d) {
        var n = this.options, b = this.element, c = b.parent();
        if (d) {
            var f = d.$grid;
        ...
        if (c.length && (c[0] == document.body || "fixed" == b.css("position") ? (b = window.innerHeight ? window.innerHeight : k(window).height(), c = k(window).width()) : (b = c.height(), c = c.width()), null == g || b != g || c != e) && (g = b, e = c, !(k.support.touch && n.editModel.indices && k(document.activeElement).is(".pq-editor-focus")))) {
            var l =
                this, n = n.autoSizeInterval, n = void 0 === n ? 0 : n;
    ...
    h._onMouseWheel = function (a) {
        this._saveDims();
        var d = this.options, n = 0, b = !1;
        a = a.originalEvent;
        var c = a.wheelDeltaX, f = a.wheelDeltaY, e = a.wheelDelta;
    ...
    h._onDblClickCell = function (a) {
        var d = k(a.currentTarget), n =
            this.getCellIndices({$td: d}), b = n.rowIndxPage, c = b + this.rowIndxOffset, n = n.colIndx;
        if (null != n) {
            ...
            1 < this.options.editModel.clicksToEdit && this.isEditableRow({rowIndx: c}) && this.isEditableCell({
                colIndx: n,
                rowIndx: c
            }) && this.editCell({rowIndxPage: b, colIndx: n})
        }
    };
    h._onClickCont = function (a) {
    };
    h._onClickRow = function (a) {
        var d = k(a.currentTarget), n = parseInt(d.attr("pq-row-indx")),
    ...
    h._onRightClickRow = function (a) {
        var d = k(a.currentTarget), n = parseInt(d.attr("pq-row-indx")), b = n + this.rowIndxOffset;
    ...
    h._onDblClickRow = function (a) {
        var d = k(a.currentTarget), n = parseInt(d.attr("pq-row-indx")), b = this.getRowIndxOffset();
        if (!1 == this._trigger("rowDblClick",
            a, {$tr: d, rowIndxPage: n, rowIndx: n + b, rowData: this.pdata[n]})) return !1
    };
    k.paramquery.getValueFromDataType = function (a, d, n) {
        if ("date" == d) return d = Date.parse(a), isNaN(d) ? "" : n ? d : a;
        if ("integer" == d) d = parseInt(a); else if ("float" == d) d = parseFloat(a); else return "bool" == d ? (d = k.trim(a).toLowerCase(), 0 == d.length ? null : "true" == d || "yes" == d || "1" == d ? !0 : "false" == d || "no" == d || "0" == d ? !1 : Boolean(d)) : k.trim(a);
    ...
    f._isValidCell = function (a) {
        var d =
            this.that, n = a.column, b = n.validations;
        if (!b || !b.length) return {valid: !0};
        var c = a.value, f = n.dataType, e = function (a) {
            return k.paramquery.getValueFromDataType(a, f, !0)
        };
        a = a.rowData;
        if (!a) throw"rowData required.";
        for (var l = 0; l < b.length; l++) {
            var g = b[l], h = g.type, p = !1, q = g.msg, m = g.value;
    ...
    f.isValidCell = function (a) {
        var d = this.that, n = a.rowData, b = a.rowIndx, c = a.value, f = a.valueDef, e =
                a.column, l = d.options, g = a.allowInvalid, h = e.dataIndx, p = l.validation, m = l.warning,
            t = l.editModel, w = t.invalidClass, t = t.warnClass, y = document.activeElement;
        if (a.checkEditable && !1 == d.isEditableCell({rowData: n, rowIndx: b, dataIndx: h})) return {valid: !0};
        a = this._isValidCell({column: e, value: c, rowData: n});
        var c = a.valid, e = a.warn, u = a.msg;
        if (c) d.data({rowData: n, dataIndx: h, data: "pq_valid"}) && (d.removeClass({
            rowData: n,
            rowIndx: b,
            dataIndx: h,
            cls: t + " " + w
        }), d.removeData({rowData: n, dataIndx: h, data: "pq_valid"})); else var p = k.extend({},
            e ? m : p, a.validation), A = p.css, C = p.cls, D = p.icon, E = p.style;
        if (g || e) {
            if (c) return {valid: !0};
            d.addClass({rowData: n, rowIndx: b, dataIndx: h, cls: e ? t : w});
            d.data({rowData: n, dataIndx: h, data: {pq_valid: {css: A, icon: D, style: E, msg: u, cls: C}}});
            return a
        }
        if (!c) {
            b = null == b ? d.getRowIndx({rowData: n}).rowIndx : b;
            if (null == b) return a;
            if (!f) d.goToPage({rowIndx: b}), d.editCell({
                rowIndx: b,
                dataIndx: h
                ...
                d.editCell({rowIndx: n, dataIndx: h})
            }
            if ((d = d.getEditCell()) && d.$cell) {
                ...
                G.tooltip({
                    position: {my: "left center+5", at: "right center"}, content: function () {
    ...
    f.isValid = function (a) {
        var d = this.that;
        a = a || {};
        var n = a.allowInvalid, b = a.checkEditable, n = null == n ? !1 : n, c = a.dataIndx;
        if (null != c) {
            var f = d.columns[c], e = a.rowData || d.getRowData(a), l = a.hasOwnProperty("value"),
                d = l ? a.value : e[c], d = this.isValidCell({
                    rowData: e,
                    checkEditable: b,
                    rowIndx: a.rowIndx,
                    value: d,
        ...
        if (null != a.rowIndx || null != a.rowIndxPage || null != a.rowData) for (var e = a.rowData || d.getRowData(a), g = d.colModel, l = [], h = 0, k = g.length; h < k; h++) {
            if (f = g[h], !f.hidden && (c = f.dataIndx, d = e[c], d = this.isValidCell({
                ...
                checkEditable: b,
                allowInvalid: n
            }), !d.valid && !d.warn)) if (n) l.push({rowData: e, dataIndx: c, column: f}); else return d
        } else {
            ...
            for (k = a.length; h < k; h++) {
                e = a[h];
                if (b && (f = this.getRowIndx({rowData: e}).rowIndx,
                !1 == d.isEditableRow({rowData: e, rowIndx: f}))) continue;
                e = this.isValid({rowData: e, rowIndx: f, checkEditable: b, allowInvalid: n});
                if (!1 === n) {
                    if (!e.valid) return e
                } else l = l.concat(e.cells)
            }
        }
        return n && l.length ? {cells: l, valid: !1} : {valid: !0}
    };
    h.isEditableRow = function (a) {
        ...
        if (null != d) {
            if ("function" == typeof d) {
                var n = a.rowIndx;
                a = a.rowData || this.getRowData({rowIndx: n});
                return d.call(this.element[0], {rowData: a, rowIndx: n})
            }
            return d
        }
        return !0
    ...
    h.isEditableCell = function (a) {
        var d = a.colIndx, n = a.dataIndx,
            d = null == d ? this.getColIndx({dataIndx: n}) : d, d = this.colModel[d], n = null == n ? d.dataIndx : n,
            b = d.editable;
        ...
        if (null != b) {
            if ("function" == typeof b) {
                ...
                return b.call(this.element[0], {rowIndx: c, rowData: a, column: d, dataIndx: n})
            }
            return b
        }
        return !0
    ...
    h._setRowPQData = function (a, d, n) {
        if (n = null == n ? this.pdata[a] : n) for (var b in d) n[b] = d[b]
    };
    h._onContMouseDown = function (a) {
        this.blurEditor({blurIfFocus: !0});
        if (!1 === this._trigger("contMouseDown", a, {dataModel: this.options.dataModel})) return !1;
        var d = k(a.target);
    ...
    h._onCellMouseEnter = function (a, d) {
        var n = this.options, b = this.getCellIndices({$td: d});
    ...
    h._onRowMouseEnter = function (a, d) {
        var n = this.options, b = this.getRowIndx({$tr: d}), c = b.rowIndxPage;
    ...
    h._onRowMouseLeave = function (a, d) {
        var n = this.getRowIndx({$tr: d}).rowIndxPage;
    ...
    h._onRowMouseUp = function (a) {
        var d = k(a.currentTarget), d = this.getRowIndx({$tr: d});
        return !1 == this._trigger("rowMouseUp", a, d) ? !1 : !0
    };
    h._onClickCell = function (a) {
        var d = this.colModel, n = this.options.editModel, b = k(a.currentTarget), c = this.getCellIndices({$td: b}),
            f = c.rowIndxPage, e = f + this.rowIndxOffset, l = c.colIndx;
        c.rowIndx = e;
        if (null != l) {
            var d = d[l], g = d.dataIndx;
            c.dataIndx = g;
            c.evt = a;
            ...
            1 == n.clicksToEdit && this.isEditableRow({rowIndx: e}) && this.isEditableCell({
                colIndx: l,
                rowIndx: e
            }) && this.editCell(c)
        }
    ...
    h._onRightClickCell = function (a) {
        var d = k(a.currentTarget), n = this.getCellIndices({$td: d}), b = n.rowIndxPage, c = b + this.rowIndxOffset,
            n = n.colIndx,
            f = this.colModel;
    ...
    h.unHighlightRow = function (a) {
        isNaN(a) || (a = this.getRow({rowIndxPage: a})) &&
    ...
    h._findCellFromEvt = function (a) {
        ...
        if (null == a || 0 == a.length) return {rowIndxPage: null, colIndx: null, $td: null};
        var d = this.getCellIndices({$td: a});
        d.$td = a;
        return d
    };
        ...
        var a = this, d = {
            change: function (d, b) {
                ...
                "remote" == c.type ? a.remoteRequest({
                    callback: function () {
                        a._onDataAvailable({apply: !0, header: !1})
                    }
                }) : a.refreshView({header: !1})
            }, refresh: function (d) {
    ...
    h.refreshDataFromDataModel = function () {
        ...
        var a = this.options, d = a.pageModel, n = a.dataModel.data, b = d.type;
        this.rowIndxOffset = 0;
        if (null == n || 0 == n.length) b && (d.curPage = 0, d.totalPages = 0, d.totalRecords = 0), this.pdata = n; else {
            if (b && "local" == b) {
                ...
                var a = (d.curPage - 1) * d.rPP, c = d.curPage * d.rPP;
    ...
    h.getQueryStringSort = function () {
        var a = this.iSort.sorters, d = "", n = this.options, b = n.stringify;
        if (n.sql) {
    ...
    h.getQueryStringFilter = function () {
        var a = this.options, d = a.sql, n = a.stringify, b = a.filterModel, a = b.mode,
            c = this.getFilterData({CM: this.colModel, location: "remote"}), f = "";
        if (b && b.on && c) if (d) {
            f = [];
            for (n = 0; n < c.length; n++) {
                var e = c[n], d = e.condition, b = e.dataIndx, e = k.trim(e.value);
            ...
            f = f.join(" " + a + " ")
        } else c.length ? (a = {mode: a, data: c}, f = !1 === n ? a : JSON.stringify(a)) : f = "";
        return f
    };
    h.remoteRequest = function (a) {
        this.loading && this.xhr.abort();
        var d = this, n = "", b = "", c = this.options, f = !1, e = this.colModel, l = c.dataModel, g = c.filterModel,
            h = c.pageModel;
        if ("function" == typeof l.getUrl) (c = l.getUrl.call(this.element[0], {
            ...
            pageModel: h,
            filterModel: g
        })) && c.url && (n = c.url), c && c.data && (b = c.data); else if ("string" == typeof l.url) {
            var n = l.url, b = {}, c = {}, p = {};
            if ("remote" == l.sorting) {
                var m = this.getQueryStringSort();
                m && (b = {pq_sort: m})
            }
            "remote" == h.type && (p = {pq_curpage: h.curPage, pq_rpp: h.rPP});
            "local" != g.type && (m = this.getQueryStringFilter()) && (f = !0, c = {pq_filter: m});
            var m = l.postData, t = l.postDataOnce;
            m && "function" ==
            typeof m && (m = m.call(this.element[0], {colModel: e, dataModel: l}));
            b = k.extend({pq_datatype: l.dataType}, c, p, b, m, t)
        }
        n && (this.loading = !0, this.showLoading(), this.xhr = k.ajax({
            ...
            success: function (b, n, c) {
                ...
                d._trigger("load", null, {dataModel: l, colModel: e});
                f && d._trigger("filter", null, {type: "remote", dataModel: l, colModel: e, filterModel: g})
            },
            error: function (a, b, n) {
                d.hideLoading();
                d.loading = !1;
                if ("function" == typeof l.error) l.error.call(d.element[0], a, b, n); else if ("abort" != n) throw"Error : " + n;
            }
        }))
    };
    ...
    h._destroyDraggable = function () {
        var a = this.element, d = a.parent(".pq-wrapper");
    ...
    h._refreshDraggable = function () {
        var a = this.element, d = this.$title;
        this.options.draggable ? (d.addClass("pq-draggable pq-no-capture"), a.parent(".pq-wrapper").length || a.wrap("<div class='pq-wrapper' />"), a.parent(".pq-wrapper").draggable({handle: d})) : this._destroyDraggable()
    };
    h._refreshResizable =
        function () {
            var a = this, d = this.element, b = this.options, c = -1 < (b.width + "").indexOf("%"),
                f = -1 < (b.height + "").indexOf("%"), e = "auto" == b.width, l = "flex" == b.width,
                g = "flex" == b.height;
            if (!b.resizable || (g || f) && (l || c || e)) this._destroyResizable(); else {
                var h = "e,s,se";
                if (g || f) h = "e"; else if (l || c || e) h = "s";
                c = !0;
                ...
                c && d.resizable({
                    ...
                    delay: 0,
                    start: function (a, d) {
                        k(d.helper).css({opacity: .5, background: "#ccc", border: "1px solid steelblue"})
                    },
                    resize: function (a, d) {
                    },
                    stop: function (d, c) {
                        var f = a.element, e = b.width, l = b.height, g = -1 < (e + "").indexOf("%"),
                            N = -1 < (l + "").indexOf("%"), h = "auto" == e, e = "flex" == e, B = !1;
    ...
    h._refreshAfterResize = function () {
        var a = this.options, d = a.width, b = a.height, a = -1 != (d + "").indexOf("%") ?
            !0 : !1, d = "auto" === d, b = -1 != (b + "").indexOf("%") ? !0 : !1;
        (a || d || b) && this.refresh()
    };
    ...
    h._refreshPager = function () {
        var a = this.options, d = a.pageModel, b = this.$footer, c = d.rPP, f = d.totalRecords;
    ...
    h._addRowsData = function (a) {
        var d = a.data, b = this.options.dataModel.data;
        a = a.rowIndx;
        null == b && (b = []);
        if (null == a) for (var c = 0, f = d.length; c < f; c++) {
            var e = d[c];
            b.push(e)
        } else if (a < b.length) for (c = 0, f = d.length; c < f; c++) e = d[c], b.splice(a, 0, e), a++; else return !1;
        return !0
    };
    ...
    h.getColIndx = function (a) {
        ...
        for (var d = this.colModel, b = 0, c = d.length; b < c; b++) if (d[b].dataIndx == a) return b
    };
    ...
    h._generateCellRowOutline = function () {
        var a = this.options, d = a.editModel;
        if (this.$div_focus) {
            if (a.debug) throw"this.$div_focus already present assert failed";
        } else a = this.element, d.inline && (a = this.getCell(d.indices), a.css("padding", 0).empty()), this.$div_focus = k("<div class='pq-editor-outer'><div class='pq-editor-inner'></div></div>").appendTo(a), this.$div_focus.css("zIndex", a.zIndex() + 5), d = k.extend({all: !0}, d.indices), d = this.getCell(d), d.css("height", d.height()), d.empty(), this.refreshEditorPos()
    };
    ...
    h.refreshEditorPos = function () {
        var a = this.options.editModel, d = a.cellBorderWidth, b = this.$div_focus, c = this.getCell(a.indices);
        if (!c) return !1;
        var a = c[0].offsetWidth - (d ? 2 * d : 1), f = c[0].offsetHeight - (d ? 2 * d : 1), e = this.element.offset(),
            c = c.offset();
        b.css({
            height: f, width: a,
            borderWidth: d, left: c.left - e.left - 1, top: c.top - e.top - 1
        })
    };
    ...
    h._findfirstUnhiddenColIndx = function () {
        for (var a = 0; a < this.colModel.length; a++) if (!this.colModel[a].hidden) return a
    };
    h.selectRow =
        function (a) {
            var d = a.evt;
    ...
    h.get$Tbl = function (a, d) {
        var b = this.$tbl, c = [];
        if (b && b.length) {
            var f = this.pqpanes, e = this.options, l = e.freezeRows, e = e.freezeCols;
    ...
    h._scrollRowVirtual = function (a) {
        var d = this.options, b = a.rowIndxPage, c = this.iHierarchy ? !0 : !1, f = a.rowIndx;
        a = this.scrollCurPos;
        ...
        if (!(b <
            ...
            var l = e.children("tbody").children("tr[pq-row-indx=" + b + "]"), g = b = l.last();
            1 < l.length && (g = l.first());
            var h = b[0], l = parseInt(e.css("marginTop"));
            if (void 0 == h) this.$vscroll.pqScrollBar("option", "cur_pos", d).pqScrollBar("scroll"); else {
                var h = h.offsetTop + h.offsetHeight, k = this.$cont[0].offsetHeight, p = this._getSBHeight(),
                    g = g.prev("tr");
                if (!g.hasClass("pq-row-hidden") && !g.hasClass("pq-last-frozen-row") && h > k - p - l) {
                    ...
                    do {
                        e += f[0].offsetHeight;
                        if (f[0] == b[0]) break; else if (c && !1 != f.hasClass("pq-detail-child") || h++, e >= g) break;
                        f = f.next()
                    } while (1);
                    c = a + h;
                    c > d && (c = d);
                    ...
                    this.$vscroll.pqScrollBar("option",
                        {num_eles: a, cur_pos: c}).pqScrollBar("scroll")
                }
            }
        }
    };
    h.blurEditor = function (a) {
        if (this.$div_focus) {
            ...
            if (a && a.blurIfFocus) document.activeElement == d[0] && d.blur(); else return d.triggerHandler("blur", a)
        }
    };
    h._scrollColumnVirtual = function (a) {
        var d = a.colIndx, d = null == d ? this.getColIndx({dataIndx: a.dataIndx}) : d;
        a = this.options.freezeCols;
        var b = this._calcRightEdgeCol(d).width, c = this._getSBWidth(), c = this.$cont[0].offsetWidth - c;
        if (b > c) {
    ...
    h.setSelection = function (a) {
        if (null == a) return this.iRows.removeAll({raiseEvent: !0}), this.iCells.removeAll({raiseEvent: !0}), !1;
        var d = this.pdata, b, c;
        if (a.rowData) b = this.getRowIndx(a).rowIndx; else {
        ...
        a.dataIndx ? this.getColIndx({dataIndx: a.dataIndx}) : a.colIndx;
        ...
        a.rowIndxPage = c;
        this.scrollRow({rowIndxPage: c});
        if (null == f) return this._selectRow(a);
        this.scrollColumn({colIndx: f});
    ...
    h.saveEditCell = function (a) {
        var d = this.options, b = d.editModel;
        if (!b.indices) return null;
        var c = k.extend({}, b.indices),
            b = a ? a.evt : null, f = c.rowIndxPage, e = f + this.rowIndxOffset, l = this.colModel[c.colIndx],
            c = l.dataIndx, g = this.pdata[f], h = d.dataModel, m;
        ...
        if (null != f) {
            ...
            "flex" == d.height ? (this.iRefresh.setContAndGridHeightFromTable(), this._fixIEFooterIssue()) : a && this.scrollRow({rowIndxPage: f});
            return !0
        }
    };
    ...
    h._digestData = function (a) {
        ...
        var d = this.options, b = d.editModel, c = d.dataModel, f = c.data, e = d.colModel, l = d.pageModel,
            g = d.historyModel, h = a.validate, h = null == h ? b.validate :
            h, m = l.type, p = a.allowInvalid, p = null == p ? b.allowInvalid : p, q = d.trackModel, b = a.track,
            b = null == b ? null == d.track ? q.on : d.track : b, t = a.history, t = null == t ? g.on : t,
            w = a.checkEditable, w = null == w ? !0 : w, y = a.checkEditableAdd, y = null == y ? w : y,
            u = this.columns, A = this.colIndxs, C = a.source, g = this.rowIndxOffset,
            D = k.paramquery.getValueFromDataType, q = a.rowList, E = q.length;
        f || (f = d.dataModel.data = []);
        for (var G = [], I = 0; I < E; I++) {
            var H = q[I], F = H.newRow, M = H.rowData, J = H.type, Q = H.checkEditable, O = H.rowIndx, R = H.oldRow;
            null == Q && ("update" == J ? Q = w :
                "add" == J && (Q = y));
            if ("update" == J) {
                if (!R || !M) throw"assert failed: oldRow and rowData required while update";
                if (Q && !0 !== d.editable && !1 === this.isEditableRow({rowIndx: O, rowData: M})) continue
            } else if ("delete" == J) {
                G.push(H);
                continue
            }
            if ("add" == J) for (var K = 0, S = e.length; K < S; K++) {
                var P = e[K], L = P.dataIndx;
                F[L] = F[L]
            }
            for (L in F) {
                P = u[L];
                K = A[L];
                if (P) {
                    if (Q && null != P.editable && !1 === this.isEditableCell({rowIndx: O, colIndx: K, dataIndx: L})) {
                        delete F[L];
                        continue
                    }
                    var S = P.dataType, K = D(F[L], S), T = M ? M[L] : void 0, T = void 0 !== T ? D(T,
                        S) : void 0;
                    F[L] = K;
                    if (h && P.validations) if ("edit" == C && !1 === p) {
                        if (P = this.isValid({dataIndx: L, rowIndx: O, value: K}), !1 == P.valid && !P.warn) return !1
        ...
        E = q.length;
        if (!E) return !1;
        t && (this.iHistory.increment(), this.iHistory.push({rowList: q}));
        for (I = 0; I < E; I++) if (H = q[I], J = H.type, F = H.newRow, O = H.rowIndx, d = H.rowIndxPage, M = H.rowData, "update" == J) for (L in b && this.iUCData.update({
            rowData: M,
            row: F,
            refresh: !1
        }), F) K = F[L], M[L] = K; else if ("add" == J) b && this.iUCData.add({rowData: F}), null == O && null == d ? f.push(F) : (d = O - g, d = "remote" == m ? d : O, f.splice(d, 0, F)), "remote" == m && l.totalRecords++; else if ("delete" == J) {
            d = this.getRowIndx({rowData: M});
            e = d.uf;
            O = d.rowIndx;
            if (b) this.iUCData["delete"]({rowIndx: O, rowData: M});
            d = O - g;
            d = "remote" == m ? d : O;
    ...
    h._fixIEFooterIssue = function () {
        k(".pq-grid-footer").css({position: "absolute"});
        k(".pq-grid-footer").css({position: "relative"})
    };
    h.refreshColumn = function (a) {
        var d = this.colModel, b = a.colIndx, c = a.dataIndx, b = null == b ? this.getColIndx({dataIndx: c}) : b,
            c = null == c ?
                d[b] : c, f = this.rowIndxOffset;
        a.colIndx = b;
    ...
    h.refreshCell = function (a) {
        if (this.pdata) {
            var d = this.rowIndxOffset, b = a.skip, c = a.rowIndx, f = a.rowIndxPage,
                c = a.rowIndx = null == c ? f + d : c, f = a.rowIndxPage =
                    null == f ? c - d : f, d = a.dataIndx, e = a.colIndx,
                e = a.colIndx = null == e ? this.getColIndx({dataIndx: d}) : e,
                l = this.getCell({all: !0, rowIndxPage: f, colIndx: e}), g = a.column, h = this.colModel;
            a.column = g ? g : h[e];
            ...
            if (g = this.pdata[f]) a.tree = k.labelIndx ? !0 : !1, a.rowData = g, l && 0 < l.length && (a = this.iGenerateView.renderCell(a), l.replaceWith(a), b || (this._fixTableViewPort(), this.iRefresh.refreshScrollbars(), this._trigger("refreshCell", null, {
                dataModel: this.options.dataModel, colModel: h, rowData: g, rowIndx: c, rowIndxPage: f,
                colIndx: e, dataIndx: d
            })))
        }
    };
    h.refreshRow = function (a) {
        if (this.pdata) {
            var d = this.rowIndxOffset, b = a.rowIndx;
            a = a.rowIndxPage;
            b = null == b ? a + d : b;
            a = null == a ? b - d : a;
            var d = this.getRow({all: !0, rowIndxPage: a}), c = this.colModel, f = this.pdata[a], e = !1,
            ...
            this._fixTableViewPort();
            this.iRefresh.refreshScrollbars();
            e && this.getRow({all: !0, rowIndxPage: a}).attr("tabindex", 0).focus();
            this._trigger("refreshRow", null, {rowData: f, rowIndx: b, rowIndxPage: a});
            return !0
        }
    };
    h.quitEditMode = function (a) {
        if (!this._quitEditMode) {
            var d = !1, b = !1, c = !1, f = this.options.editModel, e = f.indices, l = void 0;
    ...
    h.getEditCell = function () {
        ...
        if (a.indices) {
            var a =
                    this.getCell(a.indices), d = this.$div_focus.children(".pq-editor-inner"),
                b = d.find(".pq-editor-focus");
            return {$td: a, $cell: d, $editor: b}
        }
        return null
    };
    ...
    h.getFirstEditableColIndx = function (a) {
        ...
        for (var d = this.colModel, b = 0; b < d.length; b++) if (a.colIndx = b, this.isEditableCell(a) && !d[b].hidden) return b;
        return -1
    };
    h.editFirstCellInRow =
        function (a) {
            ...
            b = null == b ? a + d : b;
            a = null == a ? b - d : a;
            d = this.getFirstEditableColIndx({rowIndx: b});
            -1 != d && this.editCell({rowIndxPage: a, colIndx: d})
        };
    h._editCell = function (a) {
        var d = this, b = a.evt, c = this.rowIndxOffset, f = a.rowIndxPage, e = a.rowIndx, e = null == e ? f + c : e,
            f = null == f ? e - c : f, c = a.colIndx, l = a.dataIndx,
            c = null == c ? this.getColIndx({dataIndx: l}) : c, g = this.colModel[c], l = g.dataIndx, h = g.editor,
            m = this.options, p = m.editModel, m = m.editor, q = h ? k.extend({}, m, h) : m, h = d.pdata[f], m =
                !1;
        ...
        if (p.indices) {
            ...
            if (!1 === this.blurEditor({evt: b})) return !1;
            this.quitEditMode({evt: b})
        }
        p.indices = {rowIndxPage: f, rowIndx: e, colIndx: c, column: g, dataIndx: l};
        ...
        var A = q.init, C = q.valueIndx, D = q.dataMap, E = q.mapIndices, E = E ? E : {},
            G = "pq-editor-focus " + (q.cls ? q.cls : ""), I = G + " pq-cell-editor ", H = q.attr ? q.attr : "",
            F = q.style, M = (F = F ? F : "") ? "style='" + F + "'" : "", J = t.width() - 8,
            Q = "style='width:" + J + "px;" + F + "'", O = F ? "style='" + F + "'" : "",
            F = {rowIndx: e, rowIndxPage: f, $cell: t, cellData: y, rowData: h, cls: G, dataIndx: l, column: g};
        "function" == typeof u ? q = u.call(d.element[0],
            F) : "checkbox" == u ? (q = q.subtype, t.html("<input " + (y ? "checked='checked'" : "") + " class='" + I + "' " + H + " " + O + " type=checkbox name='" + l + "' />"), u = t.children("input"), "triple" == q && (u.pqval({val: y}), t.click(function (a) {
            k(this).children("input").pqval({incr: !0})
            ...
            Q, " name='", l, "'"].join(""), q = k.paramquery.select({
            options: G,
            attr: I,
            prepend: q.prepend,
        ...
        var d = this,
            w = t.children(".pq-editor-focus"), R = p.filterKeys;
        (y = g.editModel) && void 0 !== y.filterKeys && (R = y.filterKeys);
        var K = {$cell: t, $editor: w, dataIndx: l, column: g, colIndx: c, rowIndx: e, rowIndxPage: f, rowData: h};
        p.indices = K;
        w.data({FK: R}).on("click", function (a) {
            k(this).focus()
        }).on("keydown", function (a) {
            d.iKeyNav._keyDownInEdit(a)
        }).on("keypress", function (a) {
            return d.iKeyNav._keyPressInEdit(a, {FK: R})
        }).on("keyup", function (a) {
            return d.iKeyNav._keyUpInEdit(a, {FK: R})
        }).on("blur", function (a, b) {
            var c = d.options.editModel,
                n = c.onBlur, f = "save" == n, e = "validate" == n, l = c.cancelBlurCls, g = b ? b.force : !1;
            if (!d._quitEditMode && !d._blurEditMode && c.indices) {
                ...
                d._blurEditMode = !0;
                if (!d.saveEditCell({evt: a, silent: g || f || !e}) && !g && e) return d._deleteBlurEditMode(), !1;
                d.quitEditMode({evt: a});
        ...
        if (a) if (m) try {
            var S = w[0], P = document.createRange();
    ...
    h.getRow = function (a) {
        var d = a.rowIndxPage, b = a.rowIndx, c = this.rowIndxOffset, d = null == d ? b - c : d;
    ...
    h.getCell = function (a) {
        var d = a.rowIndxPage, b = a.rowIndx, d = null == d ? b - this.rowIndxOffset : d, b = a.colIndx, c = a.dataIndx,
            b = null == b ? this.getColIndx({dataIndx: c}) : b;
    ...
    h.getCellHeader = function (a) {
        var d = a.colIndx;
        a = a.dataIndx;
        d = null == d ? this.getColIndx({dataIndx: a}) :
            d;
        a = this.$tbl_header;
    ...
    h.getEditCellData = function () {
        var a = this.options, d = a.editModel.indices;
        if (!d) return null;
        var b = d.rowIndxPage, c = d.rowIndx, f = this.colModel[d.colIndx], e = f.editor,
            a = a.editor, a = e ? k.extend({}, a, e) : a, l = a.valueIndx, g = a.labelIndx,
            e = (e = a.mapIndices) ? e : {}, h = f.dataIndx, m = this.$div_focus.children(".pq-editor-inner"), p;
        if ("function" == typeof a.getData) p = a.getData.call(this.element[0], {
            ...
            rowIndxPage: b,
            column: f
        }); else if (d = a.type, "checkbox" == d) p = m.children(), p = "triple" == a.subtype ? p.pqval() : p.is(":checked") ? !0 : !1; else if ("contenteditable" == d) p = m.children().html(); else if ((b = m.find('*[name="' + h + '"]')) && b.length) if ("select" == d &&
            null != l) if (e[l] || this.columns[l]) {
            if (p = {}, p[e[l] ? e[l] : l] = b.val(), p[e[g] ? e[g] : g] = b.find("option:selected").text(), d = a.dataMap) if (b = b.find("option:selected").data("map")) for (c = 0; c < d.length; c++) f = d[c], p[e[f] ? e[f] : f] = b[f]
        } else p = b.val(); else p = b.val(); else (b = m.find(".pq-editor-focus")) && b.length && (p = b.val());
        return p
    };
    h.getCellIndices = function (a) {
        ...
        var d = d.attr("pq-col-indx"), c;
        null != d && (d = parseInt(d), c = this.colModel[d].dataIndx);
        return {rowIndxPage: a, rowIndx: b, colIndx: d, dataIndx: c}
    };
    h.getRowsByClass = function (a) {
        var d = this.options, b = "remote" == d.pageModel.type ? !0 : !1, c = this.rowIndxOffset, d = d.dataModel.data,
            f = [];
        if (null == d) return f;
        for (var e = 0, l = d.length; e < l; e++) {
            var g = d[e];
            a.rowData = g;
            this.hasClass(a) && (g = {rowData: g}, g.rowIndx = b ? e + c : e, f.push(g))
        }
        return f
    };
    h.getCellsByClass = function (a) {
        var d = this.options,
            b = "remote" == d.pageModel.type ? !0 : !1, c = this.rowIndxOffset, d = d.dataModel.data, f = this.colModel,
            e = f.length, l = [], g = function (a) {
                for (var d = 0; d < e; d++) {
                    var b = f[d].dataIndx;
                    a.dataIndx = b;
                    this.hasClass(a) && l.push({rowData: a.rowData, dataIndx: b, colIndx: d, rowIndx: a.rowIndx})
                }
            };
        if (null == d) return l;
        if (null != a.rowIndx || null != a.rowIndxPage || null != a.rowData) a.rowData = a.rowData || this.getRowData(a), null == a.rowIndx && (a.rowIndx = this.getRowIndx({rowData: m})), g(a); else for (var h = 0, k = d.length; h < k; h++) {
            var m = d[h];
            a.rowData = m;
            a.rowIndx = b ? h + c : h;
            g(a)
    ...
    h.data = function (a) {
        var d = a.dataIndx, b = a.data, c = null == b || "string" == typeof b ? !0 : !1;
        a = a.rowData || this.getRowData(a);
        if (!a) return null;
        if (null == d) {
            d = a.pq_rowdata;
            ...
            var e = a.pq_celldata;
            if (c) return null != e && (d = e[d], f = null == b || null == d ? d : d[b]), {data: f};
            e || (a.pq_celldata = {});
    ...
    h.attr = function (a) {
        var d = a.rowIndx, b = a.dataIndx,
            c = a.attr, f = null == c || "string" == typeof c ? !0 : !1, e = this.rowIndxOffset, l = a.refresh;
        a = a.rowData || this.getRowData(a);
        if (!a) return null;
        f || !1 === l || null != d || (d = this.getRowIndx({rowData: a}).rowIndx);
        if (null == b) {
            b = a.pq_rowattr;
            if (f) {
                var g;
            ...
            a.pq_rowattr = c;
            !1 !== l && null != d && (d = this.getRow({rowIndxPage: d - e})) && d.attr(c)
        } else {
            var h = a.pq_cellattr;
            if (f) return null != h && (d = h[b], g = null == c || null == d ? d : d[c]), {attr: g};
            h || (a.pq_cellattr = {});
            c = k.extend(a.pq_cellattr[b],
                c);
            a.pq_cellattr[b] = c;
            !1 !== l && null != d && (d = this.getCell({rowIndxPage: d - e, dataIndx: b})) && d.attr(c)
        }
    };
    h.removeData = function (a) {
        var d = a.dataIndx, b = a.data, b = null == b ? [] : b, b = "string" == typeof b ? b.split(" ") : b,
            c = b.length, f = a.rowData || this.getRowData(a);
        if (f) if (null == d) {
            if (d = f.pq_rowdata) {
                if (c) for (a = 0; a < c; a++) {
                    var e = b[a];
            ...
            var l = f[d];
            if (c) for (a = 0; a < c; a++) e = b[a], delete l[e];
            c && !k.isEmptyObject(l) || delete f[d]
        }
    };
    h.removeAttr =
        function (a) {
            var d = a.rowIndx, b = a.dataIndx, c = a.attr, c = null == c ? [] : c,
                c = "string" == typeof c ? c.split(" ") : c, f = c.length, e = d - this.rowIndxOffset, l = a.refresh,
                g = a.rowData || this.getRowData(a);
            if (g) if (!1 !== l && null == d && (d = this.getRowIndx({rowData: g}).rowIndx), null == b) {
                if (b = g.pq_rowattr) {
                    if (f) for (a = 0; a < f; a++) {
                        var h = c[a];
                        delete b[h]
                    } else for (h in b) c.push(h);
                    f && !k.isEmptyObject(b) || delete g.pq_rowattr
                }
                !1 !== l && null != d && c.length && (c = c.join(" "), (d = this.getRow({rowIndxPage: e})) && d.removeAttr(c))
            } else {
                if ((g = g.pq_cellattr) &&
                    g[b]) {
                    var m = g[b];
                    if (f) for (a = 0; a < f; a++) h = c[a], delete m[h]; else for (h in m) c.push(h);
    ...
    h.addClass = function (a) {
        var d = a.rowIndx, b = a.dataIndx, c = k.paramquery.uniqueArray, f = a.cls, e = this.rowIndxOffset,
            l = a.refresh, g = a.rowData || this.getRowData(a);
        if (g) if (!1 !== l && null == d && (d = this.getRowIndx({rowData: g}).rowIndx), null == b) {
            var b = g.pq_rowcls, h;
            h = c((b ? b + " " + f : f).split(/\s+/)).join(" ");
            g.pq_rowcls = h;
            !1 !== l && null != d && (d = this.getRow({rowIndxPage: d - e})) && d.addClass(f)
        } else {
            a = [];
    ...
    h.removeClass =
        function (a) {
            var d = a.rowIndx, b = this.getRowData(a), c = a.dataIndx, f = a.cls;
            a = a.refresh;
            if (b) {
                var e = b.pq_cellcls, l = b.pq_rowcls;
                !1 !== a && null == d && (d = this.getRowIndx({rowData: b}).rowIndx);
                if (null == c) l && (b.pq_rowcls = this._removeClass(l, f), null != d && !1 !== a && (d = this.getRow({rowIndx: d})) && d.removeClass(f)); else if (e) {
                    l = [];
    ...
    h._removeClass = function (a, d) {
        if (a && d) {
            for (var b = a.split(/\s+/), c = d.split(/\s+/), f = [], e = 0, l = b.length; e < l; e++) {
                for (var g = b[e], h = !1, k = 0, m = c.length; k < m; k++) if (g === c[k]) {
                    h = !0;
                    break
                }
                h || f.push(g)
    ...
    h.getRowIndx = function (a) {
        ...
        if (a =
            a.rowData) {
            var d = this.options, b = d.dataModel, d = "remote" == d.pageModel.type ? !0 : !1, c = b.data, f = !1,
                b = b.dataUF, e = !1;
            if (c) for (var l = 0, g = c.length; l < g; l++) if (c[l] == a) {
                e = !0;
                break
            }
            if (!e && b) for (f = !0, l = 0, g = b.length; l < g; l++) if (b[l] == a) {
                e = !0;
                break
            }
        ...
        if (null == d || 0 == d.length) return {rowIndxPage: null};
        l = d.attr("pq-row-indx");
        if (null == l) return {rowIndxPage: null};
        l = parseInt(l);
        return {rowIndxPage: l, rowIndx: l + this.rowIndxOffset}
    };
    var b = function (a) {
        this.options =
            a.options;
        this.that = a;
        var d = this, b = a.widgetEventPrefix.toLowerCase();
    ...
    h.addColumn = function (a, d) {
        var b =
            this.options, c = b.dataModel.data;
        b.colModel.push(a);
        this._calcThisColModel();
        for (b = 0; b < c.length; b++) c[b].push("")
    };
    h.rowNextSelect = function () {
        var a = this.selection({type: "row", method: "getSelection"}), d, b = this.rowIndxOffset;
        a && a[0] && (a = a[0].rowIndx, d = this.iKeyNav._incrRowIndx(a - b));
        null != d && (this.setSelection(null), this._setSelection({rowIndxPage: d}));
        return d
    };
    h.rowPrevSelect = function () {
        ...
        a && a[0] && (a = a[0].rowIndx, d = this.iKeyNav._decrRowIndx(a -
            b));
        null != d && (this.setSelection(null), this.setSelection({rowIndxPage: d}));
        return d
    };
    f._incrIndx = function (a, d) {
        var b = this.that, c = b._getLastVisibleRowIndxPage(b.pdata), b = b.colModel, f = b.length;
        if (null == d) {
            if (a == c) return null;
        ...
        return {rowIndxPage: a, colIndx: d}
    };
    f._decrIndx = function (a, d) {
        var b = this.that, c = b.colModel, f = c.length, b = b._getFirstVisibleRowIndxPage(b.pdata);
        if (null == d) {
            if (a == b) return null;
    ...
    f._incrEditIndx = function (a, d) {
        var b = this.that, c = b.colModel, f = c.length, e, l = b.rowIndxOffset,
    ...
    f._decrEditIndx = function (a, d) {
        ...
        do {
            ...
            e = c[d];
            h = a + l;
            h = b.isEditableCell({rowIndx: h, colIndx: d, checkVisible: !0})
        } while (e && (e.hidden || !1 == h));
        return {rowIndxPage: a, colIndx: d}
    };
    f._incrEditRowIndx =
        function (a, d) {
            var b = this.that, c = b.rowIndxOffset, f = b._getLastVisibleRowIndxPage(b.pdata);
            if (a == f) return null;
            do {
                a = this._incrRowIndx(a);
                var e = a + c, l = b.isEditableRow({rowIndx: e}), e = b.isEditableCell({rowIndx: e, colIndx: d}),
                    l = l && e;
    ...
    f._decrEditRowIndx = function (a, d) {
        var b = this.that, c = b.rowIndxOffset, f = b._getFirstVisibleRowIndxPage(b.pdata);
        if (a == f) return null;
        do {
            a = this._decrRowIndx(a);
            var e = a + c, l = b.isEditableRow({rowIndx: e}), e = b.isEditableCell({
                rowIndx: e,
                colIndx: d
            }), l = l && e;
            if (a == f && !l) return null
    ...
    h._onKeyPressDown = function (a) {
        if (0 < k(a.target).closest(".pq-grid-header").length) return !1 == this._trigger("headerKeyDown", a, {dataModel: this.options.dataModel}) ? !1 : !0;
        if (!1 === this.iKeyNav._bodyKeyPressDown(a) || !1 == this._trigger("keyDown", a, {dataModel: this.options.dataModel})) return !1
    };
    f._saveAndMove = function (a, d) {
        if (null == a) return d.preventDefault(), !1;
        var b = this.that, c = this.options.selectionModel, f = a.rowIndxPage,
            e = a.colIndx;
        b._blurEditMode = !0;
        if (!1 === b.saveEditCell({evt: d}) || !b.pdata) return b.pdata || b.quitEditMode(d), b._deleteBlurEditMode({
            timer: !0,
            msg: "_saveAndMove saveEditCell"
        }), d.preventDefault(), !1;
        b.quitEditMode(d);
        if (a.incr) var l,
            f = (l = d.shiftKey ? this._decrEditIndx(f, e) : this._incrEditIndx(f, e)) ? l.rowIndxPage : f,
            e = l ? l.colIndx : e;
        "row" == c.type ? (b.setSelection(null), b.setSelection({rowIndxPage: f}), b.scrollColumn({colIndx: e})) : "cell" == c.type ? (b.setSelection(null), b.setSelection({
                rowIndxPage: f,
                colIndx: e
            })) :
            (b.scrollRow({rowIndxPage: f}), b.scrollColumn({colIndx: e}));
        !1 !== a.edit && b._editCell({rowIndxPage: f, colIndx: e});
        b._deleteBlurEditMode({timer: !0, msg: "_saveAndMove"});
        d.preventDefault();
        return !1
    };
    f._keyPressInEdit = function (a, d) {
        var b = this.that, c = b.options.editModel.indices;
        d = d ? d : {};
        var f = d.FK, e = "Backspace Left Right Up Down Del Home End".split(" "), l = c.column.dataType;
    ...
    f.getValText = function (a) {
        ...
        var d = "text";
        -1 != k.inArray(a, ["input", "textarea", "select"]) && (d = "val");
        return d
    };
    f._keyUpInEdit = function (a, d) {
        var b = this.that, c = b.options;
        d = d ? d : {};
        var f = d.FK, c = c.editModel, e = c.indices;
        b._trigger("editorKeyUp", a, k.extend({}, e));
        b = e.column.dataType;
        if (f && ("float" == b || "integer" == b)) {
            var f = k(a.target), e = "integer" == b ? c.reInt : c.reFloat, c =
                this.getValText(f), l = f.data("oldVal"), g = f[c]();
            if (!1 == e.test(g)) if (e.test(l)) f[c](l); else if (b = "float" == b ? parseFloat(l) : parseInt(l), isNaN(b)) f[c](0); else f[c](b)
        }
    };
    f._keyDownInEdit = function (a) {
        var d = this.that, b = d.options, c = b.editModel.indices;
        if (c) {
            var f = k(a.target), e = k.ui.keyCode, l = b.selectionModel, g = b.editModel, c = k.extend({}, c),
                b = c.rowIndxPage, h = c.colIndx, m = c.column.editModel, g = m ? k.extend({}, g, m) : g,
                m = this.getValText(f);
            f.data("oldVal", f[m]());
            if (!1 == d._trigger("cellEditKeyDown", a, c) || !1 == d._trigger("editorKeyDown",
                a, c)) return !1;
            if (a.keyCode == e.TAB) return c = {rowIndxPage: b, colIndx: h, incr: !0}, this._saveAndMove(c, a);
            if (a.keyCode == g.saveKey) return c = "next" == g.onSave ? {
                rowIndxPage: b,
                colIndx: h,
                incr: !0
            } : {rowIndxPage: b, colIndx: h, edit: !1}, this._saveAndMove(c, a);
            if (a.keyCode == e.ESCAPE) return d.quitEditMode({evt: a}), "cell" == l.type ? d.getCell({
                rowIndxPage: b,
                colIndx: h
            }).attr("tabindex", 0).focus() : "row" == l.type && (d = d.getRow({rowIndxPage: b}), k(d[0]).attr("tabindex", 0).focus()), a.preventDefault(), !1;
    ...
    f.select = function (a) {
        var d = this.that, b = a.rowIndx, c = a.colIndx, f = d.options.selectionModel;
        a = a.evt;
        a.shiftKey && "single" != f.mode ? "row" == f.type ? (d.scrollRow({rowIndx: b}), d.iRows.extendSelection({
            rowIndx: b,
            evt: a
        })) : "cell" == f.type && (d.scrollCell({rowIndx: b, colIndx: c}), d.iCells.extendSelection({
            rowIndx: b,
            colIndx: c, evt: a
        })) : d.setSelection({rowIndx: b, colIndx: c, evt: a, setFirst: !0})
    };
    f._bodyKeyPressDown = function (a) {
        var d = this.that, b, c, f = d.rowIndxOffset, e = this.options, l = d.colModel, g = e.selectionModel,
            h = e.editModel, m = a.ctrlKey || a.metaKey, p, q, t = k.ui.keyCode, w = a.keyCode;
        if (h.indices) d.$div_focus.find(".pq-cell-focus").focus(); else {
            if ("row" == g.type) {
                c = m ? d.iRows.getFocusSelection({old: !0}) : d.iRows.getFocusSelection({old: !1});
                if (null == c) return;
                p = c.rowIndx;
                e = p - f;
                if (null == p) return;
                if (!1 == d._trigger("rowKeyDown",
                    a, {rowData: d.pdata[e], rowIndx: p, rowIndxPage: e})) return !1
            } else if ("cell" == g.type) {
                b = m ? d.iCells.getFocusSelection({old: !0}) : d.iCells.getFocusSelection({old: !1});
                if (null == b) return;
                q = b;
                p = q.rowIndx;
                var e = p - f, y = q.dataIndx;
                q = d.getColIndx({dataIndx: y});
            ...
            if (w == t.LEFT) {
                ...
                colIndx: q,
                evt: a
            }), a.preventDefault(); else if (w == t.DOWN) e = this._incrRowIndx(e), null != e && this.select({
                rowIndx: e + f,
                colIndx: q,
                evt: a
            }), a.preventDefault(); else if (w == t.PAGE_DOWN || w == t.SPACE) {
                ...
                "cell" == g.type && (q = d._getLastVisibleColIndx(), this.select({
                    ...
                    colIndx: q,
                    evt: a
                })), a.preventDefault()) : w == t.ENTER ? ("row" == g.type ? null != c && d.editFirstCellInRow({rowIndx: e + f}) : null != b && (b = d.getCell({
                rowIndxPage: e,
                colIndx: q
            })) && 0 < b.length && (p = e + f, f = d.isEditableRow({rowIndx: p}), b = d.isEditableCell({
                rowIndx: p,
                colIndx: q
            }), f && b && d.editCell({
                rowIndxPage: e,
                colIndx: q
            })), a.preventDefault()) : m && "65" == w ? ("row" == g.type && "single" != g.mode ? d.iRows.selectAll({all: g.all}) : "cell" == g.type && "single" != g.mode && d.iCells.selectAll({all: g.all}),
                ...
                rowIndx: p,
                colIndx: q
            }), f && b && d.editCell({rowIndxPage: e, colIndx: q, select: !0}))
        }
    };
    f.incrPageSize = function () {
        ...
        return {rowIndxPage: a.getRowIndx({$tr: k(f)}).rowIndxPage}
    };
    f.pageNonVirtual = function (a, d) {
        var b = this.that, c = b.$cont[0].offsetHeight - b._getSBHeight(), f = b.getRow({rowIndxPage: a}), e = 0, l = 0,
            g = k(f[0])[d]("tr.pq-grid-row"), h = g.length;
        if (0 < h) {
            do {
                f = g[l];
                e += f.offsetHeight;
            ...
            l = 0 < l ? l - 1 : l;
            do if (f = k(g[l]), a = b.getRowIndx({$tr: f}).rowIndxPage, null != a) break; else l--; while (0 <= l)
        }
        return a
    };
    f.pageDown = function (a) {
        var d = this.that, b = d.options, c = d.$vscroll.pqScrollBar("option"), f = c.cur_pos,
            e = c.num_eles, c = c.ratio;
        if (b.virtualY) {
            if (f < e - 1) {
        ...
        return {rowIndxPage: a, curPos: l}
    };
    f.pageUp = function (a) {
        var d = this.that, b = d.options, c = d.$vscroll.pqScrollBar("option"), f = c.cur_pos, c = c.ratio;
        if (b.virtualY) {
            if (0 <
                f) {
        ...
        return {rowIndxPage: a, curPos: e}
    };
    f.decrPageSize = function () {
        var a = this.that, d = a.$tbl.children("tbody").children("tr.pq-grid-row").not(".pq-group-row,.pq-summary-row"),
            b = a.options.freezeRows, c = 0;
        if (d.length) {
            var f;
            b ? (f = d.filter("tr.pq-last-frozen-row"), f.length && (f = f.next())) : 2 <= d.length && (f = k(d[1]));
            f && f.length && (c = a.getRowIndx({$tr: f}).rowIndxPage, c = c - a.pageSize + 4, 0 > c && (c = 0))
        }
        return {rowIndxPage: c}
    };
    ...
    h._getFirstVisibleRowIndxPage = function (a) {
        for (var d = 0, b = a.length; d < b; d++) if (!a[d].pq_hidden) return d
    };
    h._getLastVisibleRowIndxPage = function (a) {
        for (var d = a.length - 1; 0 <= d; d--) if (!a[d].pq_hidden) return d;
        return null
    };
    h._getFirstVisibleColIndx = function () {
        for (var a = this.colModel, d = a.length, b = 0; b < d; b++) if (!a[b].hidden) return b;
        return null
    };
    h._getLastVisibleColIndx = function () {
        for (var a = this.colModel, d = a.length - 1; 0 <= d; d--) if (!a[d].hidden) return d;
        return null
    };
    ...
    h._calcCurPosFromRowIndxPage = function (a) {
        var d = this.options, b = d.groupModel, c = b ? this.dataGM : this.pdata, f = d.freezeRows;
        if (a < f) return 0;
    ...
    h._calcCurPosFromColIndx = function (a) {
        var b = this.colModel, c = this.options.freezeCols;
        if (a < c) return 0;
        for (var f =
    ...
    var l = function (a, b, c) {
        var f = 0, e = this.options, l = e.columnBorders ? 1 : 0, g = e.numberCell, e = this.colModel;
        -1 == a && (g.show && (f = c ? f + (parseInt(g.width) + 1) : f + g.outerWidth), a = 0);
        if (c) for (; a < b; a++) {
            if ((c = e[a]) && !c.hidden) {
                if (!c._width) throw"assert failed";
                f += c._width + l
            }
        } else for (; a < b; a++) (c = e[a]) && !c.hidden && (f += c.outerWidth);
        return f
    };
    ...
    h._calcRightEdgeCol = function (a) {
        var b = 0, c = 0, f = this.colModel, e = this.hidearrHS, l = this.options.numberCell;
        l.show && (b += l.outerWidth, c++);
        for (l = 0; l <= a; l++) {
            var g = f[l];
            g.hidden || !1 != e[l] || (b += g.outerWidth, c++)
        }
        return {width: b, cols: c}
    };
    h.nestedCols = function (a, b, c) {
        ...
        for (var l = b, g = 0, h = 0, k = 0; k < f; k++) {
            ...
            if (null != m.colModel && 0 <
                m.colModel.length) {
                var p = this.nestedCols(m.colModel, b + 1, m.hidden), e = e.concat(p.colModel);
        ...
        return {depth: l, colModel: e, colSpan: g, width: 0, childCount: h}
    };
        ...
        for (var a = this.options.colModel, b = this.colModel.length, c = this.depth, f = [], e = 0; e < c; e++) {
            ...
            b; h++) {
                ...
                if (0 == e) k = a[l]; else {
                    var m = f[e - 1][h];
                    k = m.colModel;
                    if (null == k || 0 == k.length) k = m; else {
                        for (var m = h - m.leftPos, p = 0, q = 0, t = 0; t < k.length; t++) if (p += 0 < k[t].childCount ? k[t].childCount : 1, m < p) {
                            q = t;
                            break
                        }
                        k = k[q]
    ...
    h.assignRowSpan = function () {
        for (var a =
            this.colModel.length, b = this.headerCells, c = this.depth, f = 0; f < a; f++) for (var e = 0; e < c; e++) {
            var l = b[e][f];
    ...
    h._calcThisColModel = function () {
        ...
        this.depth = a.depth;
        var a = this.colModel, c = a.length;
        if (b) for (var f = 0; f < c; f++) {
            var e = a[f], l = k.extend({}, b, e, !0);
            k.extend(e, l, !0)
        }
...
(function (k) {
    ...
    k.paramquery._pqGrid.prototype.getHeaderColumnFromTD = function (e) {
        ...
        return {column: f, colIndx: c, rowIndx: e, leaf: b}
    };
    k.paramquery.cHeader = h;
    var g = h.prototype;
    g.createHeader = function () {
        var e = this.that, c = this, f = e.options, b = f.hwrap, l = e.pqpanes, a = parseInt(f.freezeCols),
            d = f.numberCell, g = e.colModel, h = e.depth, B = f.virtualX, z = f.virtualXHeader,
            v = !1 === z ? e.initHH : e.initH, z = !1 === z ? e.finalHH : e.finalH, s = e.headerCells, r = e.$header,
            x = e.$header_o;
        if (null == z) throw"finalH required for _createHeader";
        if (!1 === f.showHeader) r && r.empty(), x.css("display", "none"); else {
            x.css("display", "");
            ...
            l.vH && (d = e.$header_left = k(r[0]), l = e.$header_right =
                k(r[1]), d.css({width: b, zIndex: 1}), a = m.call(e, a, v), l.css({left: -1 * a + "px"}));
            r.click(function (a) {
    ...
    g.createHeaderCell = function (e, c, f,
                                   b, l, a, d, g) {
        var h = f[e][c], k = h.colSpan, m = h.halign, v = h.align, s = h.title;
        if (!(0 < e && h == f[e - 1][c] || 0 < c && h == f[e][c - 1] || h.hidden)) {
            ...
            b.push(["<td  ", "pq-col-indx=" + c, " ", "pq-row-indx=" + e, "  class='", f, "' rowspan=", h.rowSpan, " colspan=", k, "><div class='pq-td-div'>", s ? s : "",
                "<span class='pq-col-sort-icon'>&nbsp;</span></div></td>"].join(""))
        }
    };
    g._onHeaderCellClick = function (e, c) {
        var f = this.that, b = f.colModel[e], l = f.options, a = b.dataIndx;
        !1 !== f._trigger("headerCellClick", c, {
            column: b,
            colIndx: e,
            dataIndx: a
        }) && l.sortable && !1 != b.sortable && f.sort({colIndx: e, column: b, dataIndx: a})
    };
    g._refreshResizeColumn = function (e, c, f) {
        var b = this.that, l = b.options, a = l.filterModel.ficon ? !0 : !1, d = l.numberCell,
            l = parseInt(l.freezeCols), g = [], h = [], k = b.pqpanes.vH, m = 0, v = 0;
        ...
        for (d = 0; d <= c; d++) {
            ...
            v = f[d];
            if (!v.hidden) {
                var s = v.ficon, r = s || null == s && a, s = g, m = m + v.outerWidth;
    ...
    g.refreshHeaderSortIcons = function () {
        var e =
            this.that, c = e.iSort.sorters, f = e.$header;
        if (f) {
            ...
            for (var b = 0; b < c.length; b++) {
                var l = c[b], a = e.getColIndx({dataIndx: l.dataIndx}), d = l.dir,
    ...
    g.setDraggables = function (e) {
        ...
        k(e.target).draggable({
            axis: "x", helper: function (a, b) {
                var f = k(a.target), e = parseInt(f.attr("pq-col-indx"));
                c._setDragLimits(e);
    ...
    g._getDragHelper = function (e) {
        var c = this.that, f = parseInt(c.options.freezeCols);
        e = k(e.target);
        ...
        var b = k("td[pq-col-indx=" + e + "]", c.$header)[0], l = b.offsetLeft;
        c.pqpanes.vH ? e >= f && (l += c.$header[1].offsetLeft) : l += c.$header[0].offsetLeft;
        this.$clleft.css({left: l});
        l += b.offsetWidth;
        this.$cl.css({left: l})
    };
    g._setDragLimits = function (e) {
        if (!(0 > e)) {
            var c = this.that, f = c.colModel[e], b = c.$header_left;
    ...
    g.resizeStop = function (e, c, f) {
        var b = this.that, l = b.colModel, a = b.options.numberCell;
        this.$clleft.remove();
        this.$cl.remove();
        f = c.position.left - f;
        c = k(c.helper);
    ...
    g = function (e) {
        ...
        var c = e.options.dragColumns, f = c.topIcon, b = c.bottomIcon, l = this;
        this.status = "stop";
    ...
    g.showFeedback = function (e, c) {
        ...
        this.$arrowTop.css({left: l, top: f.$grid_inner[0].offsetTop + b.offsetTop - 16, display: ""});
        this.$arrowBottom.css({left: l, top: a, display: ""})
    };
    ...
    g.updateDragHelper = function (e) {
        var c = this.that.options.dragColumns, f = c.acceptIcon, c = c.rejectIcon, b = this.$drag_helper;
    ...
    g.setDraggables = function (e, c) {
        var f = k(e.currentTarget), b = this.that, l = b.options.dragColumns.rejectIcon, a = this;
        ...
        f.draggable({
            ...
            helper: function () {
                ...
                var c = d.attr("pq-col-indx"), f = d.attr("pq-row-indx");
                d.droppable("destroy");
    ...
    g._columnIndexOf = function (e, c) {
        for (var f =
            0, b = e.length; f < b; f++) if (e[f] == c) return f;
        return -1
    };
    g.setDroppables = function (e) {
        var c = this.that, f = this, b = {
            hoverClass: "pq-drop-hover ui-state-highlight", tolerance: "pointer", drop: function (a, b) {
                if (!f.dropPending) {
                    var e = parseInt(b.draggable.attr("pq-col-indx")), l = parseInt(b.draggable.attr("pq-row-indx")),
                        g = k(this), h = parseInt(g.attr("pq-col-indx")), m = parseInt(g.attr("pq-row-indx")),
                        s = c.options.colModel, r = c.headerCells, g = r[l][e], l = 0 == l ? s : r[l - 1][e].colModel,
                        e = 0 == m ? s : r[m - 1][h].colModel, h = r[m][h], g = f._columnIndexOf(l,
                        g), g = l.splice(g, 1)[0], h = f._columnIndexOf(e, h);
...
(function (k) {
    function h(g) {
        ...
        this.detachView = !1;
        var c = g.widgetEventPrefix.toLowerCase(), f = g.eventNamespace;
    ...
    m.tableWidthChange = function () {
        if (this.refreshComplete) {
            ...
            for (var g = this.that.$tbl.children("tbody").children("tr.pq-detail-child").children("td.pq-detail-child"), e = 0, c = g.length; e < c; e++) for (var f = k(g[e]).find(".pq-grid"), b = 0, l = f.length; b < l; b++) {
                var a = k(f[b]);
    ...
    m.aftertable = function (g) {
        var e = this.that, c = e.options.detailModel.init, f = e.pdata;
        if (this.refreshComplete) {
            this.refreshComplete = !1;
            g = g ? g : e.$tbl.children("tbody").children("tr.pq-detail-child");
            for (var b = 0, l = g.length; b < l; b++) {
                var a = k(g[b]), d = a.attr("pq-row-indx"), h = f[d], d = !1, m = h.pq_detail.child;
                m || "function" != typeof c || (d = !0, m = c.call(e.element[0], {rowData: h}), h.pq_detail.child = m, h.pq_detail.height = 25);
    ...
    m.detachInitView = function (g) {
        var e = this.that.$tbl;
        if (e && e.length) for (g = g ? g : e.children("tbody").children("tr.pq-detail-child"), e = 0; e < g.length; e++) k(g[e]).children("td.pq-detail-child").children().detach()
    };
    m.toggle = function (g, e) {
        var c = this.that, f = e.column, b = e.rowData, l = e.rowIndx, a = this.type;
        f && f.type === a && (f = {
            rowIndx: l,
            focus: !0
    ...
    m.rowExpand = function (g) {
        this.normalize(g);
        var e = this.that, c = g.rowData, f = g.rowIndx, b = g.rowIndxPage, l = e.options.detailModel;
        if (null != c) {
            if (!1 === e._trigger("beforeRowExpand", null, g)) return !1;
            null == c.pq_detail ? c.pq_detail = {show: !0} : !1 === c.pq_detail.show && (c.pq_detail.show = !0);
            l.cache || this.rowInvalidate(g);
            e.refreshRow({rowIndx: f});
            l = [];
            e.iGenerateView._generateDetailRow(c, b, e.colModel, l, null, !1);
            c = e.getRow({rowIndxPage: b});
            c.after(l.join(""));
            this.aftertable(c.next());
            g.focus && e.getCell({rowIndx: f, dataIndx: "pq_detail"}).attr("tabindex", "0").focus();
            g.scrollRow && this.scrollRow({rowIndx: f})
        }
    };
    ...
    m.normalize = function (g) {
        var e = this.that, c = g.rowIndx, f = g.rowIndxPage,
            b = e.rowIndxOffset;
    ...
    m.rowCollapse = function (g) {
        this.normalize(g);
        var e = this.that, c = e.options, f = g.rowData, b = g.rowIndx, l = g.rowIndxPage, a = c.detailModel;
        null != f && null != f.pq_detail && !0 === f.pq_detail.show && (a.cache || this.rowInvalidate(g), f.pq_detail.show = !1, c.virtualY ? e.refresh() : (c = e.getRow({rowIndxPage: l}).next("tr.pq-detail-child"), c.length && (this.detachInitView(c), c.remove(), e.refreshRow({rowIndx: b})), g.focus && e.getCell({
            rowIndx: b,
            dataIndx: "pq_detail"
        }).attr("tabindex", "0").focus()), g.scrollRow && (b = g.rowIndx, this.scrollRow({rowIndx: b})))
    }
})(jQuery);
(function (k) {
    var h = k.paramquery.pqgrid.calcWidthCols, m = function (g) {
        this.that = g
    };
    ...
    m.autoFit = function () {
        var g = this.that, e = g.colModel, c = e.length, g = h.call(g, -1, c, !0), f = this.contWd - this.getSBWidth();
        if (g !== f) {
            for (var g = g - f, b, f = [], l = 0; l < c; l++) {
                var a = e[l], d = a._percent,
                    n = a._resized;
                a.hidden || d || n || (0 > g ? (d = a._maxWidth - a._width) && f.push({
                    availWd: -1 * d,
                    colIndx: l
                }) : (d = a._width - a._minWidth) && f.push({availWd: d, colIndx: l}));
            ...
            for (c = f.length; l < c; l++) {
                var a = f[l], d = a.availWd, a = a.colIndx, n = Math.round(g / (c - l)), a = e[a], k;
                k = a._width;
    ...
    m.autoLastColumn = function () {
        var g = this.that, e = g.options, c = e.columnBorders ? 1 : 0, f = g.colModel, b = f.length, e = e.freezeCols,
            l = this.contWd - this.getSBWidth(), a = h.call(g, -1, e, !0), l = l - a, a = !1,
    ...
    m.refreshColumnWidths = function () {
        var g = this.that, e = g.options, c = e.numberCell, f = "flex" === e.width, b = e.columnBorders ? 1 : 0,
            l = g.colModel, a = e.scrollModel, d = a.lastColumn, a = a.autoFit, h = this.contWd, k = l.length,
            m = this.getSBWidth(), z = e._minColWidth, v = e._maxColWidth, s = 0;
        ...
        if (!f && 5 > c || isNaN(c)) {
            ...
            for (m = 0; m < k; m++) if (s = l[m], !s.hidden) {
                var r = s.width, x = -1 < (r + "").indexOf("%") ? !0 : null, p = s.minWidth, q = s.maxWidth,
                    p = p ? this.numericVal(p, c) : z, q = q ? this.numericVal(q, c) : v;
                q < p && (q = p);
                if (void 0 != r) {
                    var t = 0;
    ...
    m._refreshFrozenLine = function () {
        var g = this.that, e = g.options, c = e.numberCell, f = g.$cont_o, e = e.freezeCols;
    ...
    m._setScrollVNumEles = function () {
        var g = this.that, e = g.$vscroll, c = g.options;
        if ("flex" === c.height) return e.pqScrollBar("option", "num_eles", 0), 0;
        var f = g.iHierarchy ? !0 : !1, b = e.pqScrollBar("option"), l = parseInt(b.num_eles), b = parseInt(b.cur_pos),
            l = this.getSBHeight(), l = this.contHt - l + 1,
            c = (c.groupModel ? g.dataGM : g.pdata) ? g.totalVisibleRows : 0, a, d = 0;
    ...
    m._setScrollVLength = function () {
        ...
        if ("flex" !== g.options.height) {
            var e = this.getSBHeight(), c = this.contHt - e;
            g.$vscroll.css("bottom", e).pqScrollBar("option", "length", c)
        }
    };
    m.setContAndHeaderHeight = function () {
        var g = this.that, e = g.options, c = g.$header, f, b, l;
        if (c && c.length) {
            if (1 < c.length) {
                if (f = c[0].offsetHeight, b = c[1].offsetHeight, l = Math.max(f, b), f !== b) {
                    var a = k(c[0]).find(".pq-grid-header-search-row"), d = k(c[1]).find(".pq-grid-header-search-row");
                    a.css("height", "");
                    d.css("height", "");
                    f = c[0].offsetHeight;
                    b = c[1].offsetHeight;
    ...
    m.setContAndGridHeightFromTable = function () {
        var g = 0, e = this.that, c = this.getSBHeight(), g = (g = e.$tbl) && g.length ? k(g[0]).data("offsetHeight") :
            23;
        this.contHt = g + c - 1;
        e.$cont.height("");
        e.element.height("");
    ...
    m.setContAndGridWidthFromTable = function () {
        var g = this.that, e = h.call(g, -1, g.colModel.length), g = g.element, c = this.getSBWidth();
        this.contWd = e + c;
        g.width(this.contWd + "px")
    };
    m.getTotalVisibleRows = function (g, e, c) {
        var f = this.that, b = this.estRowsInViewPort(), l = 0, a = c ? c.length : 0, d = e, h = 0, k = 0, m = null,
            z = !1, v = !1, s = f.iHierarchy ? !0 : !1, r = f.options, x = r.detailModel.offset, p = 0, q = this.rowHt,
            f = s ? f.$cont[0].offsetHeight : void 0;
        if (null == c ||
            0 == a) return {initV: null, finalV: null, tvRows: l, lastFrozenRow: null};
        for (var t = 0, w = a > e ? e : a; t < w; t++) {
            var y = c[t], u = y.pq_hidden;
            u || (m = t, l++, s && ((y = y.pq_detail) && y.show ? (y = y.height || 0, y > x && (y = x), p += y + q) : p += q))
        }
        if (a < e) return {initV: m, finalV: m, tvRows: l, lastFrozenRow: m};
        ...
        d >= a && (d = a - 1);
        h < d && (h = d);
        return {initV: d, finalV: h, tvRows: l, lastFrozenRow: m}
    };
    m.calcInitFinal = function () {
        var g = this.that, e = g.options, c = e.virtualY, f = e.freezeRows, b = "flex" === e.height,
            e = e.groupModel ? g.dataGM : g.pdata;
        if (null == e || 0 === e.length) f = this.getTotalVisibleRows(l, f, e), g.totalVisibleRows = f.tvRows, g.initV = f.initV, g.finalV = f.finalV, g.lastFrozenRow = f.lastFrozenRow; else if (c) {
            var c = g.$vscroll.pqScrollBar("option"), l = parseInt(c.cur_pos);
            if (isNaN(l) ||
    ...
    m.calcInitFinalH = function () {
        var g = this.that, e = g.options, c = e.virtualX, f = g.colModel, b = f.length;
        if (c) {
            !1 === e.virtualXHeader && (g.initHH = 0, g.finalHH = b - 1);
            for (var l = parseInt(g.$hscroll.pqScrollBar("option",
                "cur_pos")), a = parseInt(e.freezeCols), d = "flex" === e.width, n = a, k = 0, m = a; m < b; m++) if (f[m].hidden) n++; else if (k === l) break; else n++, k++;
            n > b - 1 && (n = b - 1);
            g.initH = n;
            if (d || !c) g.finalH = b - 1; else {
                c = h.call(g, -1, a);
                l = this.getEContWd();
                for (m = n; m < b; m++) if (n = f[m], !n.hidden) {
                    n = n.outerWidth;
    ...
    m.refreshGridWidthAndHeight =
        function () {
            var g = this.that, e = g.options, c, f, b = -1 < (e.width + "").indexOf("%") ? !0 : !1,
                l = -1 < (e.height + "").indexOf("%") ? !0 : !1, g = g.element;
            if (b || l) {
                var a = g.parent();
                if (!a.length) return;
                var d, h;
                ...
                var m = null, B = this._calcOffset, z = b ? B(e.width) : 0, B = l ? B(e.height) : 0;
                if (0 == d) {
                    for (; "BODY" != a[0].tagName.toUpperCase();) {
                        var v = a.parent();
                        if (null == v[0]) {
                            m = a;
                            break
                    ...
                    if (m) {
                        var v = m.css("position"), s = m.css("left"), r = m.css("top");
                        m.css({position: "absolute", left: "-2000", top: "-2000"}).appendTo(k(document.body));
                        a = g.parent();
                        b && (d = a.width());
                        l && (h = a.height());
                        m.css({position: v, left: s, top: r})
                    }
                }
    ...
    m.decidePanes = function () {
        var g = this.that, e = g.pqpanes = {v: !1, h: !1, vH: !1}, c = g.options, g = c.virtualX, f = c.virtualXHeader,
            b = c.virtualY, l = "flex" == c.height, a = "flex" == c.width, d = c.numberCell, h = c.freezeRows,
            c = c.freezeCols;
    ...
    m._storeColumnWidths = function (g) {
        var e = this.that, c = e.colModel,
            f = g ? c.length - 1 : e.finalH, b = [];
        for (g = g ? 0 : e.initH; g <= f; g++) b[g] = {outerWidth: c[g].outerWidth};
        return b
    };
    m._isColumnWidthChanged = function (g) {
        for (var e = this.that, c = e.colModel, f = e.finalH, e = e.initH; e <= f; e++) if (c[e].outerWidth !== g[e].outerWidth) return !0;
        return !1
    };
    m.refreshScrollbars = function () {
        var g = this.that, e = g.options, c = "flex" === e.height, f = "flex" === e.width;
    ...
    m._setScrollHLength = function () {
        var g = this.that, e = g.$hscroll, c = g.$hvscroll;
    ...
    m.calcColsOutsideCont = function (g) {
        var e = this.that.options, c = e.numberCell, e = e.freezeCols, f = this.contWd - this.getSBWidth(), b = 0;
        c.show && (b += c.outerWidth);
        for (c = 0; c < g.length; c++) {
            var l = g[c];
            l.hidden || (b += l.outerWidth)
        }
        var a = 0, d = 0, l = Math.round(b);
        l > f && d++;
        for (c = e; c < g.length; c++) if (l = g[c], !l.hidden) if (a += l.outerWidth, l = b - a, l > f) d++; else break;
        return d
    };
    m._setScrollHNumEles =
        function () {
            var g = this.that, e = g.options, c = g.colModel, f = e.scrollModel, b = 0;
    ...
    m._refresh = function (g) {
        ...
        if (f[0].offsetWidth) {
            ...
            !1 !== c ? e._createHeader() : this._isColumnWidthChanged(b) && this._refreshTableWidths(b, {header: !0});
            e._refreshHeaderSortIcons();
            e._refreshPager();
            this.setContAndHeaderHeight();
            !1 !== g ? e.iGenerateView.generateView() : (this._refreshTableWidths(b, {table: !0}), e._saveDims(), e.iGenerateView.scrollView());
...
(function (k) {
    var h = {
        getFocusElement: function () {
            ...
            if (b) {
                var b = k(b), c = b.closest(".pq-grid");
                if (c.length) return c[0] == this.element[0] ? {$ae: b, $grid: c} : {$ae: b, $childGrid: c}
            }
        ...
        function c(a, d, f) {
            b.filter({data: [{dataIndx: a, value: d, value2: f}]})
        }
    ...
    g.get$Ele = function (b, c) {
        var a = this.that, d = a.options.freezeCols, f = k(a.$tbl_header[0]),
            e = ".pq-grid-hd-search-field[name='" + c + "']", a = k(a.$tbl_header[2 == a.$tbl_header.length ? 1 : 0]);
        return b >= d ? a.find(e) : f.find(e)
    };
    g.onKeyDown = function (b, c, a) {
        c = this.that;
        if (b.keyCode === k.ui.keyCode.TAB) {
            var d = a.attr("name"), f = c.getColIndx({dataIndx: d}), e = c.colModel, g, h = b.shiftKey, m = e[f];
            if ("between" == m.filter.condition && (c.scrollColumn({colIndx: f}), d = this.get$Ele(f, d), d[0] == a[0] ? h || (g = d[1]) : h && (g =
    ...
    g._bindFocus = function () {
        function b(b) {
            ...
            if (c.scrollColumn({dataIndx: b})) {
                var d = c.getColIndx({dataIndx: b});
                a.get$Ele(d,
                    b).focus()
            }
        }
    ...
    g._onCreateHeader = function () {
        ...
        if (c.filterModel.header) {
            this._bindFocus();
            var a = b.colModel, d = c.freezeCols, f = c.virtualX, e = c.virtualXHeader,
                c = !1 === e ? b.initHH : b.initH, e = !1 === e ? b.finalHH : b.finalH, g = b.$tbl_header, h = k(g[0]),
                m = k(g[1]), s = "input,select";
            if (1 < g.length) {
                h.find(s).css("visibility", "hidden");
                for (var r = 0; r < d; r++) {
                    var x = a[r], s = "*[name='" + x.dataIndx +
                        "']";
            ...
            for (r = 0; r <= e; r++) {
                ...
                if (!x.hidden) {
                    var p = x.filter;
                    if (p) {
                        var s = x.dataIndx, q = h;
                        r >= d && 1 < g.length && (q = m);
                        q = q.find("*[name='" + s + "']");
                        if (0 != q.length) {
                            var t = p.type, w = p.value, y = p.value2;
                            "checkbox" == t && "triple" == p.subtype ? q.pqval({val: w}) : "select" == t && null != w && q.val(w);
                            (t = p.init) && t.call(q, {dataIndx: s, column: x});
                            if (x = p.listeners) for (p = 0; p < x.length; p++) {
                                t = x[p];
                                "string" == typeof t &&
                                (t = this[t + "Listener"]);
                                for (var u in t) (function (a, d, c) {
                                    a.bind(u, function (f) {
                                        var e = b.getColumn({dataIndx: c}), l = e.filter;
                                        "checkbox" == l.type ? w = "triple" == l.subtype ? a.pqval({incr: !0}) : a.is(":checked") ? !0 : !1 : "between" == l.condition ? (w = k(a[0]).val(), y = k(a[1]).val()) : w = a.val();
                                        return d.call(this, f, {column: e, dataIndx: c, value: w, value2: y})
                                    })
                                })(q, t[u], s)
                            }
                        }
    ...
    g.createDOM = function (b, c) {
        var a = this.that, d = a.options, f = d.virtualX, e = d.virtualXHeader, g = !1 === e ? a.initHH : a.initH,
            e = !1 === e ? a.finalHH : a.finalH, h = d.freezeCols,
            m = a.colModel, s = d.numberCell, d = function (a, b) {
        ...
        for (s = 0; s <= e; s++) {
            ...
            if (!r.hidden) {
                ...
                (p = r.cls) && (x = x + " " + p);
                if (p = r.filter) {
                    var q = r.dataIndx, t = p.type, w = p.value, y = p.condition, u = p.cls,
                        u = "pq-grid-hd-search-field " + (u ? u : ""), A = p.style, A = A ? A : "", C = p.attr,
                        C = C ? C : "", D = "";
                    if ("between" == y) var E = p.value2, E = null != E ? E : "";
                    "textbox" === t ? (w = w ? w : "", u += " ui-corner-all pq-search-txt", D = "between" == y ? d(this._input(q, w, u + " pq-from", A, C), this._input(q, E, u + " pq-to", A, C)) : this._input(q, w, u, A, C)) : "textarea" === t ? (w = w ? w : "", u += " ui-corner-all pq-search-txt", D = "between" == y ? d(this._textarea(q,
                        ...
                        " name='", q, "' type=checkbox class='" + u + "' style='" + A + "' " + C + "/>"].join("") : "string" == typeof t ? D = t : "function" == typeof t && (D = t.call(a.element[0], {
                        width: wd,
                        value: w,
                        value2: E,
                        column: r,
    ...
    k.paramquery.select = function (b) {
        var c = b.options, a = b.groupIndx, d = b.labelIndx, f = b.valueIndx, e = null != d && null != f, g = null != a,
            h = b.prepend, k = b.dataMap, m, r, x;
        b = ["<select ", b.attr, " >"];
        if (h) for (var p in h) b.push('<option value="', p, '">', h[p], "</option>");
        if (c && c.length) {
            for (var h = 0, q = c.length; h < q; h++) {
                var t = c[h];
                if (e) {
                    var w = t[f], y = t.pq_disabled ? 'disabled="disabled" ' :
                ...
                } else if ("object" == typeof t) for (p in t) b.push('<option value="', p, '">', t[p], "</option>");
    ...
    k.fn.pqval = function (b) {
        if (b) {
            ...
            null == b ? (this.prop("indeterminate", !0), this.prop("checked", !1)) : b ? this.prop("checked",
                !0) : this.prop("checked", !1);
            return this
        }
    ...
    var e = {
        _generateTitleRow: function (b, c, a, d) {
            ...
            d = c.groupTitle;
            var e = c.level, g = c.GMRowIndx, h = b.title, k = b.icon,
            ...
            var e = c.level, g = c.rowData, h = "pq-summary-row pq-grid-row" +
                (f ? " pq-last-frozen-row" : "");
            (b = b.summaryCls) && (b = b[e]) && (h += " " + b);
            b = this.that;
            var k = b.options;
            f = k.virtualX;
            var m = b.initH, r = b.finalH, x = k.freezeCols, p = k.numberCell, k = k.columnBorders;
            d.push("<tr class='" + h + "'>");
            p.show && d.push("<td class='pq-grid-number-cell ui-state-default'>&nbsp;</td>");
            for (h = 0; h <= r; h++) {
                if (h < m && h >= x && f && (h = m, h > r)) throw"initH>finalH";
                var p = a[h], q = p.dataIndx;
                if (!p.hidden) {
                    var t = "pq-grid-cell ";
    ...
    g.showHideRows = function (b, c, a) {
        for (var d = [], f = this.that.dataGM, e = f.length; b < e; b++) {
            var g = f[b], h = g;
            if (h.groupSummary) if (g.level < c) break; else g.pq_hidden = a; else if (h.groupTitle) if (g.collapsed && d.push({
                indx: b,
                level: g.level
            }), g.level <= c) break; else g.pq_hidden = a; else g.pq_hidden = a
        }
        return d
    };
    g.onClickGroupRow = function (b) {
        ...
        b = this.that;
        var a = parseInt(c.attr("level")), c = parseInt(c.attr("GMRowIndx")),
            d = !0, d = b.dataGM[c];
        d = d.collapsed ? d.collapsed = !1 : d.collapsed = !0;
        if (d) this.showHideRows(c + 1, a, !0); else for (c = this.showHideRows(c + 1, a, !1), d = 0; d < c.length; d++) {
            var f = c[d].indx, a = c[d].level;
    ...
    g.initcollapsed = function () {
        ...
        if (b) for (var c = 0, a = b.length; c < a; c++) {
            var d = b[c];
        ...
        if (d && c && 0 < c.length) {
            ...
            for (var u = 0, A = c.length; u <= A; u++) {
                ...
                if (p) {
                    ...
                    if (0 < u) {
                        for (r = h - 1; r >= D; r--) if (s[r]) {
                            for (var E = [], G = 0; G < e; G++) if (p = a[G], q = (q = p.summary) ? q.type ? q.type[r] : null : null) {
                                var I = p.dataIndx, H = "",
                                    H = "function" == typeof q ? q(y[r][I], p.dataType) : this[q](y[r][I], p.dataType);
                                E[I] = H
                            }
                            d.push({groupSummary: !0, level: r, prevRowData: c[u - 1], rowData: E})
                        }
                        for (p = D; p < h; p++) d[x[p]].items = y[p][a[0].dataIndx].length
                    }
                    if (u == A) break;
                    for (r = h - 1; r >= D; r--) for (q = 0; q <
                ...
                C.pq_hidden = !1;
                d.push(C);
                for (D = 0; D < e; D++) for (p = a[D], I = p.dataIndx, r = 0; r < h; r++) y[r][I].push(C[I])
            }
            b.dataGM = d
        } else b.dataGM = null
    };
    h.options = {
        ...
        dragColumns: {
            enabled: !0, acceptIcon: "ui-icon-check", rejectIcon: "ui-icon-closethick",
            topIcon: "ui-icon-circle-arrow-s", bottomIcon: "ui-icon-circle-arrow-n"
        },
        track: null,
        treeModel: {
            collapsed: !0,
        ...
        filterModel: {on: !0, mode: "AND", header: !1}
    };
    h._create = function () {
        ...
        this._createToolbar();
        "remote" === b.dataModel.location && this.refresh({table: !0});
        this.refreshDataAndView({header: !0})
    };
    h._createToolbar = function () {
        var b = this.options, c = b.toolbar;
        if (c) {
            var a = c.cls, d = c.style, f = c.attr, c = c.items,
                a = k("<div class='" + (a ? a : "") + "' style='" + (d ? d : "") + "' " + (f ? f : "") + " ></div>").appendTo(k(".pq-grid-top", this.element));
            a.pqToolbar({items: c, gridInstance: this});
    ...
    h.filter = function (b) {
        var c = this, a = this.options, d = void 0 === b.apply ? !0 : b.apply, f = void 0 === b.sort ? !0 : b.sort,
            e = a.dataModel, a = a.filterModel;
        if (void 0 != b) {
            ...
            for (var h = this.colModel, h = d ? h : k.extend(!0, [], h), m = 0, s = h.length, r = b.length, x = 0; x < s; x++) {
                for (var p = h[x], q = !1, t = 0; t < r && m != r; t++) {
                    ...
                    if (w.dataIndx == p.dataIndx) {
                        q = !0;
                        m++;
                        var t = p.filter, y = w.condition, u = w.value;
                        t ? t.on = !0 : t = p.filter = {on: !0};
                        y && (t.condition = y);
                        y = t.condition;
                        t.value = u;
                        if ("between" == y) t.value2 =
                            w.value2; else if ("range" == y) {
                            w = [];
                            if (u) if ("string" == typeof u) {
                                var y = t.options, A = u.indexOf('"'), C = u.lastIndexOf('"'), u = u.substr(A, C + 1),
                                    u = JSON.parse("[" + u + "]");
                                if (y) for (A = 0, C = y.length; A < C; A++) {
                                    var D = y[A];
                                    -1 != k.inArray(D, u) && w.push(D)
                                } else w = u.split(",s*")
        ...
        var E = {header: !1, apply: d, sort: f, CM: h};
        if ("remote" == e.location && "local" != a.type) this.remoteRequest({
            apply: d, CM: h, callback: function () {
    ...
    g._refreshSorters = function (b, c) {
        var a = this.that.options, d = a.dataModel, f = d.sortIndx, e = k.isArray(f), g = a.groupModel,
            h = g ? g.dataIndx : null, m = g ? g.dir : null, s = -1, a = [];
        if (g) for (g = 0; g < h.length; g++) {
            var r = h[g];
            r == b && (s = g);
            a.push({dataIndx: r, dir: m && m[g] ? m[g] : "up"})
        }
        ...
        if (null != d.sortIndx) if (e) for (g = 0; g < f.length; g++) e = f[g], -1 == this.inSorters(a, e) && a.push({
            dataIndx: e,
            dir: d.sortDir[g]
        }); else -1 == this.inSorters(a, d.sortIndx) && a.push({dataIndx: d.sortIndx, dir: d.sortDir});
        this.sorters = a
    };
    g.inSorters = function (b, c) {
        for (var a = -1, d = 0; d < b.length; d++) if (b[d].dataIndx == c) {
            a = d;
            break
        }
        return a
    ...
    g.sortLocalData = function (b) {
        for (var c =
            ...
            var e = d[f], g = c.getColIndx({dataIndx: e.dataIndx}), g = a[g], h = g.sortType;
    ...
    g._sortLocalData = function (b, c) {
        ...
        function h(a, b, c, d) {
            ...
            b = b[c];
            c = 0;
            if (a && !b || !1 === a && null === b) c = 1; else if (b && !a || !1 === b && null === a) c = -1;
            return c * d
        }
        ...
        (function () {
            for (var k = [], m = [], r = [], x = b.length, p = 0; p < x; p++) {
                var q = b[p], t = "up" == q.dir ? 1 : -1,
                    w = q.sortType, y = q.dataType;
                m[p] = q.dataIndx;
                r[p] = t;
    ...
    h.getIndxInSorters = function (b) {
        for (var c = this.sorters,
                 a = 0, d = c.length; a < d; a++) if (c[a].dataIndx == b) return a;
        return -1
    };
    ...
    h.getData = function (b) {
        var c = b.dataIndx, a = c.length;
        b = b.data;
        var d = this.options.dataModel, f = d.data, d = d.dataUF, e = [], g = function (b) {
        ...
        b ? g(b) : (f && g(f), d && g(d));
        b = [];
        for (f = 0; f < a; f++) d = c[f], g = this.getColumn({dataIndx: d}), b.push({
            dataIndx: d,
            dir: "up",
            dataType: g.dataType
        });
    ...
    h.getFilterData = function (b) {
        ...
        for (var e = k.paramquery.filter.getAllConditions, g = k.paramquery.filter.getTRConditions,
            ...
            var r = c[s], x = r.dataIndx, p = r.dataType, p = p && "function" != typeof p ? p : "string", q = r.filter;
            if (b) {
                if ((q = r.filterModel) && q.on) {
                    for (var t = [], w = q.mode, y = q.filters, r = 0; r < y.length; r++) {
                        var q = y[r], u = q.value, A = q.condition;
                        m(A, u) && (u = v(u, p), t.push({value: u, condition: A}))
                    }
                    h.push({
                        dataIndx: x,
                        mode: w, dataType: p, filters: t
                    })
                }
            } else if (q && q.on && (u = q.value, t = q.value2, A = q.condition, m(A, u, t))) {
                if ("between" == A) "" === u || null == u ? (A = "lte", u = v(t, p)) : "" === t || null == t ? (A = "gte", u = v(u, p)) : (u = v(u, p), t = v(t, p)); else if ("regexp" == A) if ("remote" == d) u = u.toString(); else {
                    if ("string" == typeof u) try {
                        var C = q.modifiers, C = C ? C : "gi", u = new RegExp(u, C)
                    } catch (D) {
                        u = /.*/
                    }
                } else if ("range" == A) if (null == u) continue; else if ("string" == typeof u) u = v(u, p), u = u.split(/\s*,\s*/); else {
    ...
    g.isMatchCellSingle = function (b, c) {
        var a = b.dataType, d = b.value, e = b.value2, g = b.cbFn, h = c[b.dataIndx],
            h = "regexp" == b.condition ? null == h ? "" : h : f.convert(h, a);
        return g(h, d, e) ? !0 : !1
    };
    g.isMatchCellMultiple = function (b, c) {
        var a = b.dataIndx, d = b.dataType,
            f = b.mode, e = b.filters, g = e.length;
        if (0 == g) return !0;
        for (var h = 0; h < g; h++) {
            var k = e[h], k = this.isMatchRule(c[a], k.condition, k.value, d);
            if ("OR" == f && k) return !0;
            if ("AND" == f && !k) return !1
        }
        if (1 === g) return k;
    ...
    h.filterLocalData = function (b) {
        ...
        b = !1 === c ? b.CM :
            this.colModel;
        var a = this.getFilterData({CM: b}), d = this.options, e = d.dataModel, g = e.data, h = e.dataUF, k = [],
            m = [], d = d.filterModel, s = d.multiple, r = d ? d.mode : null, x = new f;
        x.isMatchCell = s ? x.isMatchCellMultiple : x.isMatchCellSingle;
        if (d.on && r) {
            if (g) for (var s = 0, p = g.length; s < p; s++) {
                var q = g[s];
                x.isMatchRow(q, a, r) ? k.push(q) : m.push(q)
            }
            if (h) for (s = 0, p = h.length; s < p; s++) q = h[s], x.isMatchRow(q, a, r) ? k.push(q) : m.push(q)
        } else {
            if (g) for (s = 0, p = g.length; s < p; s++) q = g[s], k.push(q);
            if (h) for (s = 0, p = h.length; s < p; s++) q = h[s], k.push(q)
        }
        c &&
        ...
        return {data: k, dataUF: m}
    };
    h._onDataAvailable = function (b) {
        b = b ? b : {};
        var c = this.options, a = b.apply, d = b.source, f = b.sort, e = [], e = c.filterModel, c = c.dataModel,
            g = c.location;
        !1 !== a && this._trigger("dataAvailable", b.evt, {dataModel: c, source: d});
    ...
    h.sort = function (b) {
        b = b ? b : {};
        var c = this, a = this.options, d = b.colIndx, f = a.editModel, e = b.dataIndx, g = b.dir, h = b.evt,
            k = a.dataModel;
        if (null == d && null == e && (e = k.sortIndx, null == e)) return;
        var d = null == d ? this.getColIndx({dataIndx: e}) : d, m = this.colModel[d], e = null == e ? m.dataIndx : e;
        !1 != c._trigger("beforeSort", h, {
            dataModel: k,
            column: m,
            dataIndx: e
        }) && (f.indices && c.blurEditor({force: !0}), this.iSort._refreshSorters(e, g), "local" == k.sorting ? (this.iSort.sortLocalData(k.data), c._trigger("sort",
            h, {
                dataModel: k,
                column: m,
                dataIndx: e
            ...
            callback: function () {
                c._trigger("sort", h, {dataModel: k, column: m, dataIndx: e});
                c._onDataAvailable()
            }
        }))
    };
...
(function (k) {
    ...
    k.paramquery.pqgrid.exportToExcel = function (h) {
        var m = this, g = void 0 === h.urlPost ? h.url : h.urlPost, e = h.url,
        ...
        k.ajax({
            url: g, type: "POST", cache: !1, data: {extension: h, excel: f}, success: function (b) {
...
(function (k) {
    var h = k.paramquery.pqGrid.prototype.options, m = {on: !1, dirtyClass: "pq-cell-dirty"};
    ...
    h = (k.paramquery.cUCData = function (g) {
        ...
        var e = this, c = g.eventNamespace, f = g.widgetEventPrefix.toLowerCase();
    ...
    h.add = function (g) {
        var e = this.that, c = this.adata;
        g = g.rowData;
        for (var f = this.options.trackModel.dirtyClass, b = e.getRecId({rowData: g}), h = 0, a = c.length; h < a; h++) {
            var d = c[h];
        ...
        var h = [], k;
        for (k in g) h.push(k);
        e.removeClass({rowData: g, dataIndx: h, cls: f});
        g = {recId: b, rowData: g};
        c.push(g)
    };
    h.update = function (g) {
        var e = this.that, c = this.options.trackModel.dirtyClass, f = g.rowData || e.getRowData(g),
            b = e.getRecId({rowData: f}), h = g.dataIndx, a = g.refresh, d = e.columns,
            n = k.paramquery.getValueFromDataType;
        g = g.row;
        var m = this.udata, B = m.slice(0), z = !1;
        if (null != b) {
            for (var v = 0, s = m.length; v < s; v++) {
                var r = m[v], x = r.oldRow;
                if (r.rowData == f) {
                    z = !0;
            ...
            if (!z) {
                ...
                for (h in g) x[h] = f[h], m = {
                    rowData: f,
                    dataIndx: h, refresh: a, cls: c
                }, e.addClass(m);
                m = {rowData: f, recId: b, oldRow: x};
                B.push(m)
            }
            this.udata = B
        }
    ...
    h["delete"] = function (g) {
        var e = this.that, c = g.rowIndx, f = g.rowIndxPage, b = e.rowIndxOffset, c = null == c ? f + b : c,
            f = "remote" == e.options.pageModel.type ? null == f ? c - b : f : c, b = this.adata, h = this.ddata;
        g = e.getRowData(g);
        for (var e = 0, a = b.length; e < a; e++) if (b[e].rowData == g) {
            b.splice(e, 1);
            return
        }
        h.push({indx: f, rowData: g, rowIndx: c})
    };
    h.isDirty = function (g) {
        var e = this.udata, c = this.adata, f = this.ddata, b = !1;
        if (g = this.that.getRowData(g)) for (c =
                                                  0; c < e.length; c++) {
            if (g == e[c].rowData) {
                b = !0;
                break
    ...
    h.getChangesValue = function () {
        for (var g = this.udata, e = this.adata, c = this.ddata, f = {
            ...
            var z = c[m], z = z.rowData, v = {};
            d.push(z);
            for (var s in z) 0 != s.indexOf("pq_") && (v[s] = z[s]);
            n.push(v)
        }
        for (m = 0; m < g.length; m++) if (z = g[m], z = z.rowData, -1 == k.inArray(z, d) && -1 == k.inArray(z, b)) {
            v = {};
    ...
    h.getChangesRaw = function () {
        var g = this.adata, e = this.ddata, c = {updateList: [], addList: [], deleteList: []};
    ...
    h.commitAdd = function (g, e) {
        for (var c = this.that.colModel, f = c.length, b = this.adata, h = k.inArray, a = b.length, d = k.paramquery.getValueFromDataType, n = [], m = g.length, B = [], z = 0; z < m; z++) for (var v = g[z], s = 0; s < a; s++) {
            var r = b[s].rowData, x = !0;
            if (-1 == h(r, B)) {
                for (var p = 0; p < f; p++) {
                    var q = c[p], t = q.dataType, w = q.dataIndx;
                ...
                if (x) {
                    ...
                    s[e] = v[e];
                    x[e] = r[e];
                    n.push({type: "update", rowData: r, oldRow: x, newRow: s});
                    B.push(r);
                    break
                }
            }
    ...
    h.commitUpdate = function (g, e) {
        for (var c = this.that, f = this.options.trackModel.dirtyClass, b = c.colModel, h = b.length, a = this.udata, d = a.length, n = g.length, m = [], B = 0; B < d; B++) {
            var z = a[B], v = z.rowData, z = z.oldRow;
            if (-1 == k.inArray(v, m)) for (var s = 0; s < n; s++) if (v[e] ==
                g[s][e]) {
                m.push(v);
                for (var r = 0; r < h; r++) var x = b[r].dataIndx;
                for (x in z) c.removeClass({rowData: v, dataIndx: x, cls: f})
            }
        }
        c = [];
    ...
    h.commitDelete = function (g, e) {
        for (var c = this.ddata, f = c.length, b = g.length, h = [], a = 0; a < f; a++) for (var d = c[a].rowData, n = 0; n < b; n++) d[e] == g[n][e] && h.push(d);
        b = [];
    ...
    h.commitUpdateAll = function () {
        for (var g = this.that, e = this.options.trackModel.dirtyClass,
            ...
            var h = c[f], a = h.oldRow, h = h.rowData, d;
            for (d in a) g.removeClass({rowData: h, dataIndx: d, cls: e})
        }
        this.udata = []
    };
    ...
    h.commit = function (g) {
        var e = this.that, c = g ? g.history : null, c = null == c ? !1 : c, f = [], f = [], b = [],
            h = e.options.dataModel.recIndx;
        if (null == g) this.commitAddAll(), this.commitUpdateAll(), this.commitDeleteAll(); else {
            var a = g.type;
            g = g.rows;
    ...
    h.rollbackDelete = function (g, e) {
        for (var c = this.ddata, f = [], b = c.length - 1; 0 <= b; b--) {
            ...
            f.push({
                type: "add",
                rowIndx: h.rowIndx, newRow: h.rowData
            })
        }
        this.ddata = [];
        return f
    ...
    h.rollbackUpdate = function (g, e) {
        for (var c = this.that, f = this.options.trackModel.dirtyClass, b = this.udata, h = [], a = 0, d = b.length; a < d; a++) {
            var k = b[a], m = k.rowData, B = {}, z = k.oldRow;
            if (null != k.recId) {
                var k = [], v;
                for (v in z) B[v] = m[v], k.push(v);
                c.removeClass({rowData: m, dataIndx: k, cls: f, refresh: !1});
                h.push({type: "update", rowData: m, newRow: z, oldRow: B})
            }
        }
        this.udata = [];
        return h
    ...
    h.rollback = function (g) {
        var e = this.that, c = e.options.pageModel, f = g && null != g.refresh ?
            g.refresh : !0;
        g = g && null != g.type ? g.type : null;
        var b = [], b = [], h = [], a = [], d = e.options.dataModel.data;
        ...
        b = b.concat(a, h);
        e._digestData({history: !1, allowInvalid: !0, checkEditable: !1, source: "rollback", track: !1, rowList: b});
        f && e.refreshView()
    };
    ...
    h._getRowIndx = function () {
        var g = this.selection({type: "row", method: "getSelection"});
        if (g && 0 < g.length) {
            var g = g[0].rowIndx, e = this.options.pageModel, c = g - this.rowIndxOffset, f = e.rPP;
            if (e.type) {
                if (0 <= c && c < f) return g
            } else return g
        } else return null
    ...
    h.updateRow =
        function (g) {
            var e = g.rowIndx, c = g.row, f = g.rowData || this.getRowData({rowIndx: e});
            if (!f) return !1;
            var b = {}, h;
            for (h in c) b[h] = f[h];
            if (!1 === this._digestData({
                ...
                rowList: [{newRow: c, oldRow: b, rowData: f, rowIndx: e, type: "update"}]
            })) return !1;
            !1 !== g.refresh && this.refreshRow({rowIndx: e})
        };
    h.updateElseAdd = function (g) {
        var e = g.row;
        null == this.getRowData({rowIndx: g.rowIndx}) ? (g.rowData = e, this.addRow(g)) : this.updateRow(g)
    };
    h._fillForm = function (g) {
        var e = this.colModel, c = this.rowIndxOffset, f = null == g.rowIndxPage ? g.rowIndx - c : g.rowIndxPage;
    ...
    h.getRowData = function (g) {
        ...
        var e = g.rowData;
        if (null != e) return e;
        var c = this.options, e = c.dataModel, c = c.pageModel.type, f = e.recIndx, b = g.recId, e = e.data;
        if (null != b) for (g = 0, c = e.length; g < c; g++) {
            var h = e[g];
            if (h[f] == b) return h
    ...
    h.deleteRow = function (g) {
        var e =
            g.rowIndx, c = g.rowIndxPage, f = this.rowIndxOffset, e = null != c ? c + f : e;
        null != e && (c = g.rowData || this.getRowData({rowIndx: e}), this._digestData({
            source: g.source || "delete",
            history: g.history,
            track: g.track,
            rowList: [{rowIndx: e, rowData: c, oldRow: c, type: "delete"}]
        }), !1 !== g.refresh && this.refreshView())
    };
    h.addRow = function (g) {
        var e = g.rowData || g.row, c = g.rowIndx, f = g.rowIndxPage, b = this.rowIndxOffset, c = null != f ? f + b : c,
            f = this.options.dataModel, b = f.data;
        ...
        if (!1 === this._digestData({
            ...
            track: g.track,
            checkEditable: g.checkEditable,
            rowList: [{newRow: e, rowIndx: c, type: "add"}]
        })) return !1;
        !1 !== g.refresh && this.refreshView();
...
(function (k) {
    k.widget("paramquery.pqToolbar", {
        options: {items: [], gridInstance: null}, _create: function () {
            var h = this.options, m = h.gridInstance, g = m.colModel, e = h.items, c = this.element;
            c.closest(".pq-grid");
            c.addClass("pq-toolbar");
            for (var f = 0, b = e.length; f < b; f++) {
                var l = e[f], h = l.type, a = l.icon, d = l.label, n = l.listener, N = n ? [n] : l.listeners, n = l.cls,
                    n = "ui-corner-all " + (n ? n : ""), B = l.style, B = B ? 'style="' + B + '"' : "", z = l.attr,
                    z = z ? z : "", v;
                ...
                h ? v = k("<input type='checkbox' class='" + n + "' " + z + " " + B + ">").appendTo(c) : "separator" == h ? k("<span class='pq-separator '" + n + "' " + z + " " + B + "></span>").appendTo(c) : "button" == h ? (h = l.options ? l.options : {}, k.extend(h, {
                    text: d ? !0 : !1,
                    icons: {primary: a}
                }), v = k("<button type='button' class='" + n + "' " + z + " " + B + ">" + d + "</button>").button(h).appendTo(c)) : "select" == h ? (h = l.options ? l.options : [], "function" === typeof h && (h = h.call(m.element[0], {colModel: g})), v = k.paramquery.select({
                    options: h, attr: " class='" + n + "' " + z + " " + B, prepend: l.prepend,
                    groupIndx: l.groupIndx, valueIndx: l.valueIndx, labelIndx: l.labelIndx
...
(function (k) {
    ...
    m.triggerSelectChange = function (c) {
        ...
        if (f.options.selectionModel.fireSelectChange) {
            var b = f.iRows.getSelection(), e = f.iCells.getSelection(), a = c.evt;
            c = c.ui;
            b = {rows: b, cells: e};
    ...
    m.getOldCellSel = function () {
        ...
        if ((f =
            ...
            var b = f.rowData, c = c.getRowIndx({rowData: b});
            c.rowData = b;
    ...
    m.getNewRowSel = function () {
        var c = this.that, f = document.activeElement ? k(document.activeElement) : null;
        if (f && f.hasClass("pq-grid-row") && f.closest(".pq-grid")[0] == c.element[0]) return c = c.getRowIndx({$tr: f}), c.$tr = f, c
    };
    m.getNewCellSel = function () {
        var c = this.that, f = document.activeElement ? k(document.activeElement) : null;
        if (f && f.hasClass("pq-grid-cell") && f.closest(".pq-grid")[0] ==
            c.element[0]) return c = c.getCellIndices({$td: f}), c.$td = f, c
    };
    ...
    m.getLastSelection = function () {
        ...
        if (c) {
            var f = c.rowData,
                b = this.that.getRowData({rowIndx: rowIndx});
    ...
    m.getLastSelectionCurPage = function () {
        ...
        if (c && this.isSelected(c)) {
            var f = c.rowIndx, b = this.that.options.pageModel;
            if (b.type) {
                var e = b.curPage;
    ...
    m.getSelectionCurPage = function () {
        var c = this.that, f = this.getSelection(), b = [], e = c.options.pageModel;
        if (e.type) {
            for (var c = e.curPage,
    ...
    m.inViewRow = function (c) {
        var f = this.that, b = this.options, e = f.rowIndxOffset, a = f.initV, d = f.finalV;
        if (c < b.freezeRows) return !0;
        if (b.groupModel) {
            if ((f = f.dataGM) && f.length) for (; a <= d; a++) if (b = f[a].rowIndx - e, null != b && b == c) return !0;
            return !1
        }
        return c >= a && c <= d
    };
    ...
    h.extendSelection = function (c) {
        var f = this.that, b = c.rowIndx, e = f.options.selectionModel.mode;
        c = c.evt;
        var a = this.getFirstSelection();
        null == a ? f.setSelection({rowIndx: b}) : "single" != e && (e = f = a.rowIndx, a = b, f > b && (e = b, a = f), this.selectRange({
            initRowIndx: e,
            finalRowIndx: a,
            evt: c
        }), this.add({rowIndx: b}))
    ...
    h.refresh = function () {
        this.selection = [];
        var c = this.that, f = c.options, b = "remote" == f.pageModel.type ? !0 : !1, c = c.rowIndxOffset,
            e = [];
        if (f = f.dataModel.data) {
            for (var a = 0, d = f.length; a < d; a++) {
                var g = f[a];
                g.pq_rowselect && e.push({rowIndx: b ? a + c : a, rowData: g})
            }
            this.selection = e
        }
    };
    h.replace = function (c) {
        var f = c.rowIndx, b = null == c.offset ? this.that.getRowIndxOffset() : c.offset;
        c.offset = b;
        c.rowIndxPage = f - b;
    ...
    h.indexOf = function (c) {
        this.refresh();
        c = c.rowIndx;
        for (var f = this.selection, b = 0; b < f.length; b++) if (f[b].rowIndx == c) return b;
        return -1
    };
    ...
    h._boundRow = function (c) {
        var f = c.rowIndxPage, b = this.that;
        c = null == c.$tr ? b.getRow({rowIndxPage: f}) : c.$tr;
        if (null == c || 0 == c.length) return !1;
        c.addClass("pq-row-select ui-state-highlight");
        return c
    };
    h.selectRange = function (c) {
        var f = c.initRowIndx, b = c.finalRowIndx;
        c = c.evt;
        for (var e = this.getSelection().slice(0), a = [], d = 0; d < e.length; d++) {
            var g = e[d], h = g.rowIndx;
            (h < f || h > b) && a.push({rowIndx: h, rowData: g.rowData})
        }
        this.remove({rows: a, evt: c});
        a = [];
        f > b && (e =
            f, f = b, b = e);
        for (h = f; h <= b; h++) a.push({rowIndx: h, evt: c});
        this.add({rows: a, evt: c})
    };
    ...
    m.extendSelection = function (c) {
        var f = this.that, b = this.getFirstSelection(), e = c.rowIndx, a = c.colIndx,
            d = f.options.selectionModel.mode;
        c = c.evt;
        if (null == b) f.setSelection({rowIndx: e, colIndx: a}); else {
            var g = b.rowIndx, f = f.getColIndx({dataIndx: b.dataIndx}), b = g, h = e, k = f, m = a;
            g > e && (b = e, h = g);
            "range" == d ? (g > e &&
    ...
    h.removeAll = function (c) {
        ...
        var f = this.that, b = c && null != c.all ? c.all : !0;
        this.refresh();
        c = this.selection.slice(0);
        if (b) this.remove({rows: c}), this.lastSelection = null; else {
            for (var b = [], e = f.rowIndxOffset, f = (f = f.pdata) ? f.length : 0, a = 0, d = c.length; a < d; a++) {
                var g = c[a], h = g.rowIndx - e;
                if (0 <= h) if (h < f) b.push(g); else break
            }
            this.remove({rows: b})
        }
    };
    m.isSelected = function (c) {
        var f = this.that, b = c.rowData || f.getRowData(c), e = c.dataIndx;
        c = c.colIndx;
        if (null ==
    ...
    m.refresh = function () {
        this.selection = [];
        var c = this.that, e = c.options.dataModel.data, b = [], g = "remote" == c.options.pageModel.type ? !0 : !1,
            c = c.rowIndxOffset, a = this.that.colModel, d = a.length;
        if (e) {
            for (var h = [], k = 0; k < d; k++) {
                var m = a[k].dataIndx;
                h[k] = m
            ...
            for (var k = 0, z = e.length; k < z; k++) {
                var v = e[k], s = v.pq_cellselect;
                if (s) for (var r = g ? k + c : k, x = 0; x < d; x++) m = h[x], s[m] && b.push({
                    rowIndx: r, rowData: v, dataIndx: m,
                    colIndx: x, column: a[x]
                })
            }
            this.selection = b
        }
    ...
    m.replace = function (c) {
        var e = c.rowIndx, b = null == c.offset ? this.that.getRowIndxOffset() : c.offset;
        c.rowIndxPage = e - b;
        c.offset = b;
        this.removeAll({raiseEvent: !0});
        this.add(c)
    ...
    m.inViewCell = function (c, e) {
        var b = this.that, g = this.options.freezeCols;
        return this.inViewRow(c) ? e < g || e >= b.initH && e <= b.finalH : !1
    };
    m._add = function (c) {
        var e = this.that, b = c.rowIndx, g = c.rowIndxPage, a = c.rowData || e.getRowData(c), d = e.rowIndxOffset, h,
            b = null == b ? g + d : b, g = null == g ? b - d : g, d = c.colIndx, k = c.dataIndx,
            d = null == d ? e.getColIndx({dataIndx: k}) : d, m = e.colModel[d], k = null == k ? m.dataIndx : k,
            z = c.evt, v = this.isSelected({rowData: a, dataIndx: k});
        if (null == v) return !1;
        var s = this.inViewCell(g, d);
        if (!1 === v) {
            if (s) {
                var r = e.getCell({rowIndxPage: g, colIndx: d});
                r && r.addClass("pq-state-select ui-state-highlight")
            }
            this._addToData({rowData: a, dataIndx: k});
        ...
        this.lastSelection = {rowIndx: b, dataIndx: k, rowData: a};
        !1 !== c.focus &&
        ...
        c.setFirst && (this.firstSelection = {rowIndx: b, rowData: a, dataIndx: k});
        if (h) return {rowIndx: b, rowData: a, dataIndx: k, colIndx: d, column: m}
    };
    h._add = function (c) {
        var e = this.that, b, g = c.rowIndx, a = c.rowIndxPage, d = e.rowIndxOffset, g = null == g ? a + d : g,
            a = null == a ? g - d : a, h = null == h ? e.getRowData(c) : h, d = c.$tr, m = c.evt,
            B = this.isSelected({rowData: h});
        c.rowIndxPage = a;
        if (null == B) return !1;
        ...
        this.lastSelection = {rowIndx: g, rowData: h};
        !1 !== c.focus && z && (d && d.length || (d = e.getRow({rowIndxPage: a})), d && (d = k(d[0]), d.attr("tabindex", "0"), d.focus(), e._fixTableViewPort(), this.focusSelection = {
            rowData: h,
            rowIndx: g
        }));
        c.setFirst && (this.firstSelection = {rowIndx: g, rowData: h});
        if (b) return {rowIndx: g, rowData: h}
    };
    m.add = function (c) {
        var e = this.that, b = c.evt, g = c.cells, a = !1, d = [];
        if (g && "function" == typeof g.push) {
            c = 0;
            for (var h = g.length; c < h; c++) a = g[c], a.trigger = !1, (a = this._add(a)) && d.push(a);
            d.length && (a = !0, e._trigger("cellSelect", b, {cells: d}))
        } else a = this._add(c);
        a && (e._fixIE(), this.triggerSelectChange({evt: b}))
    };
    h.add = function (c) {
        var e = this.that, b = c.evt, g = c.rows, a = !1, d = [];
        if (g && "function" == typeof g.push) {
            c = 0;
            for (var h = g.length; c < h; c++) a = g[c], a.trigger = !1, (a = this._add(a)) && d.push(a);
    ...
    m._remove = function (c) {
        var e = this.that, b = c.rowIndx, g = c.rowIndxPage, a = e.rowIndxOffset, b = null == b ? g + a : b,
            g = null == g ? b - a : g, a = c.rowData || e.getRowData(c), d = c.colIndx, h = c.dataIndx,
            d = null == d ? e.getColIndx({dataIndx: h}) : d, k = c.column, k = null == k ? e.colModel[d] : k,
            h = null == h ? k.dataIndx : h, m = c.evt;
        if (this.isSelected({rowData: a, dataIndx: h})) return this.inViewCell(g, d) && (g = e.getCell({
            rowIndxPage: g,
            colIndx: d,
            all: !0
            ...
            dataIndx: h,
            rowData: a
        }), {rowIndx: b, rowData: a, dataIndx: h, colIndx: d, column: k}
    };
    h._remove = function (c) {
        var e = this.that, b = c.rowIndx, g = c.rowIndxPage, a = e.rowIndxOffset, b = null == b ? g + a : b,
            g = null == g ? b - a : g, a = c.rowData, a = null == a ? e.getRowData(c) : a, d = c.$tr, h = c.evt;
        if (this.isSelected({rowData: a})) return this.inViewRow(g) && (d = e.getRow({rowIndxPage: g})) && (d.removeClass("pq-row-select ui-state-highlight"),
    ...
    m.remove = function (c) {
        var e = c.cells, b = c.evt, g = !1;
        if (e && "function" == typeof e.push) {
            c = [];
            for (var a = 0, d = e.length; a < d; a++) g = e[a], g.trigger = !1, (g = this._remove(g)) && c.push(g);
            c.length && (g = !0, this.that._trigger("cellUnSelect", b, {cells: c}))
        } else g = this._remove(c);
        g && this.triggerSelectChange({evt: b})
    };
    h.remove = function (c) {
        var e = c.rows, b = c.evt, g = !1;
        if (e && "function" == typeof e.push) {
            c =
                [];
            for (var a = 0, d = e.length; a < d; a++) g = e[a], g.trigger = !1, (g = this._remove(g)) && c.push(g);
            c.length && (g = !0, this.that._trigger("rowUnSelect", b, {rows: c}))
        } else g = this._remove(c);
        g && this.triggerSelectChange({evt: b})
    };
    m.indexOf = function (c) {
        this.refresh();
        var e = c.rowIndx, b = this.that, b = null == c.dataIndx ? b.colModel[c.colIndx].dataIndx : c.dataIndx;
        c.dataIndx = b;
        c = this.selection;
    ...
    m.selectAll = function (c) {
        var e = this.that, b = c && c.all ?
            !0 : !1;
        c = b ? this.options.dataModel.data : e.pdata;
        var g = e.rowIndxOffset, a = e.colModel, d = a.length, h = [], e = function (b, c) {
            for (var e = 0; e < d; e++) {
                var f = a[e];
                f.hidden || h.push({rowIndx: c, rowData: b, colIndx: e, dataIndx: f.dataIndx, focus: !1})
            }
        };
        if (c) {
            for (var k = 0, m = c.length; k < m; k++) var z = c[k];
            if (b) for (b = "remote" == this.options.pageModel.type ? !0 : !1, k = 0, m = c.length; k < m; k++) {
                var z = c[k], v = k;
                b && (v = k + g);
                e(z, v)
            } else for (k = 0, m = c.length; k < m; k++) z = c[k], v = k + g, e(z, v);
            this.add({cells: h})
        }
    };
    h.selectAll = function (c) {
        var e = this.that, b =
            c && c.all ? !0 : !1, e = b ? this.options.dataModel.data : e.pdata;
        c = [];
        if (e) {
            if (b) for (var b = "remote" == this.options.pageModel.type ? !0 : !1, g = 0, a = e.length; g < a; g++) {
                var d = {rowData: e[g], focus: !1};
                b ? d.rowIndxPage = g : d.rowIndx = g;
                c.push(d)
            } else for (g = 0, a = e.length; g < a; g++) c.push({rowIndxPage: g, rowData: e[g], focus: !1});
            this.add({rows: c})
        }
    };
    m.selectRange = function (c) {
        var e = this.that, b = c.initRowIndx, g = c.initColIndx, a = c.finalRowIndx;
        c = c.finalColIndx;
        for (var d = e.colModel, h = d.length, k = this.getSelection().slice(0), m = [], z = 0; z < k.length; z++) {
            var v =
                k[z], s = v.rowIndx, r = v.dataIndx, v = e.getColIndx({dataIndx: r});
            s < b || s > a ? m.push({rowIndx: s, colIndx: v, dataIndx: r}) : s == b && v < g ? m.push({
                rowIndx: s,
                colIndx: v,
                dataIndx: r
            }) : s == a && v > c && m.push({rowIndx: s, colIndx: v, dataIndx: r})
        }
        this.remove({cells: m});
        m = [];
        for (v = 0; v < h; v++) if (e = d[v], !e.hidden) {
            r = e.dataIndx;
            s = b;
            do {
                if (!(s == b && v < g)) if (s == a && v > c) break; else m.push({
                    rowIndx: s,
                    colIndx: v,
                    dataIndx: r,
                    focus: !1
    ...
    m.selectBlock = function (c) {
        ...
        for (var h = this.getSelection().slice(0), k = e.colModel, m = [], z = 0; z < h.length; z++) {
            var v = h[z], s = v.rowIndx, v = v.dataIndx, r = e.getColIndx({dataIndx: v});
            r < g || r > d ? m.push({rowIndx: s, colIndx: r, dataIndx: v}) : (s < b || s > a) && m.push({
                rowIndx: s,
                colIndx: r,
                dataIndx: v
            })
        ...
        this.remove({cells: m});
        m = [];
        for (r = g; r <= d; r++) if (e = k[r], v = e.dataIndx, !e.hidden) {
            s = b;
            do m.push({rowIndx: s, colIndx: r, dataIndx: v, focus: !1}), s++; while (s <= a)
        }
        this.add({cells: m, evt: c})
    }
})(jQuery);
(function (k) {
    var h = (k.paramquery.cCheckBoxColumn = function (h, g) {
        ...
        this.column = g;
        this.cb = g.cb = g.cb || {all: !1, header: !0};
        this.dataIndx = g.dataIndx;
        var c = h.widgetEventPrefix.toLowerCase(), f = h.element, b = h.eventNamespace;
    ...
    h.setValCBox = function () {
        if (this.hasHeaderChkBox()) {
            ...
            c == k ? g = !0 : f == k && (g = !1);
            this.$inp.pqval({val: g})
        }
    };
    h.onHeaderClick = function (h) {
        var g = this.that, e = k(h.currentTarget).find("input"), c = this.column, f = c.dataIndx,
            b = g.getColIndx({dataIndx: f}), l = this.cb.all ? g.options.dataModel.data : g.pdata,
            c = {column: c, dataIndx: f, source: "header"}, a = k(h.target).is("input") ? !0 : !1, d = e.is(":checked"),
            n = d;
        a || (n = !d);
        if (n) {
    ...
    h.refreshHeader = function (h, g) {
        if (this.hasHeaderChkBox()) {
            ...
            if (e.pdata) {
                var c = this;
                if (e = e.getCellHeader({dataIndx: this.dataIndx})) e.html("<input type='checkbox'/>"), this.$inp =
    ...
    h.selectAllRows = function () {
        this.that.iRows.selectAll({all: this.cb.all})
    };
    h.unSelectAllRows = function () {
        this.that.iRows.removeAll({all: this.cb.all})
    };
    h._onDataAvailable = function () {
        var h = this.that, g = this.options, e = g.dataModel.data,
            g = "remote" == g.pageModel.type ? h.rowIndxOffset : 0, c = this.column, f = c.dataIndx;
        if (null != f && e) {
            for (var b = [], k = 0, a = e.length; k < a; k++) {
                var d = e[k];
                d[f] && b.push({rowIndx: k + g, rowData: d})
            }
    ...
    h.rowSelect = function (h, g) {
        var e = this.that, c = g.rows, f = g.rowData, b = this.dataIndx;
        if (c) for (var k = 0, a = c.length; k < a; k++) {
            var f = c[k], d = f.rowIndx, f = f.rowData;
            f[b] = !0;
            e.refreshCell({rowIndx: d, dataIndx: b})
        } else f && (f[b] = !0, d = g.rowIndx, e.refreshCell({rowIndx: d, dataIndx: b}));
        this.setValCBox()
    };
    h.rowUnSelect = function (h,
        ...
        if (c) for (var k = 0, a = c.length; k < a; k++) {
            ...
            f[b] = !1;
            e.refreshCell({rowIndx: d, dataIndx: b})
        } else f && (f[b] = !1, d = g.rowIndx, e.refreshCell({rowIndx: d, dataIndx: b}));
        this.setValCBox()
    };
    h.raiseEvent = function (h, g) {
        var e = this.that, c = g.rowData, f = k(h.originalEvent.target).is("input") ? !0 : !1, b = g.rowIndx,
            l = g.dataIndx;
        if (c[l]) {
            if (!1 === e._trigger("beforeunCheck", h, g)) return !1;
            c[l] = !1;
            f || (c = e.getCell(g).find("input"), c.pqval({val: !1}));
            !1 !== e._trigger("unCheck", h, g) && e.iRows.remove({rowIndx: b})
        } else {
            if (!1 === e._trigger("beforeCheck", h, g)) return !1;
            c[l] = !0;
            f || (c = e.getCell(g).find("input"), c.pqval({val: !0}));
            !1 !== e._trigger("check", h, g) && e.iRows.add({rowIndx: b})
        }
        this.setValCBox();
        if (!f) return !1
    };
    h.cellKeyDown = function (h, g) {
        if (g.dataIndx = this.dataIndx) if (13 == h.keyCode || 32 == h.keyCode) return this.raiseEvent(h, g)
    }
})(jQuery);
(function () {
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function (g) {
        var e = (new Date).getTime(), e = Math.max(0, 16 - (e - k));
...
(function (k) {
    function h(e) {
        this.that = e;
        var c = this, f = e.element, b = e.widgetEventPrefix.toLowerCase();
        e = e.eventNamespace;
        this.scrollLeft = this.scrollTop = 0;
    ...
    g._beforeTableView = function (e, c) {
        var f = this.that, b = f.getFocusElement();
        this.lastFocus = null;
        b && b.$grid && (b = b.$ae, b.hasClass("pq-grid-row") ? this.lastFocus = f = f.getRowIndx({$tr: b}) : b.hasClass("pq-grid-cell") && (this.lastFocus = f = f.getCellIndices({$td: b})))
    };
    g.inViewPort = function (e) {
        var c = this.that.iRefresh, f = c.getEContHt(), c = c.getEContWd() + 1;
        e = e[0];
        var b = this.scrollLeft;
        if (f >= e.offsetTop + e.offsetHeight + this.marginTop) if ("TD" == e.nodeName.toUpperCase()) {
            if (c >= e.offsetLeft +
                e.offsetWidth + b) return !0
        } else return !0
    };
    g._onRefresh = function (e, c) {
        var f = this.that, b = this.lastFocus;
        b && (f = null != b.dataIndx ? f.getCell(b) : f.getRow(b)) && f.length && f.attr("tabindex", "0").focus()
    };
    g._onCellMouseDown = function (e, c) {
        var f = this.that, b = c.rowIndx, g = c.colIndx, a = f.options.selectionModel, d = a.mode;
        if ("cell" == a.type && null != g) return e.shiftKey ? (f.iCells.extendSelection({
            ...
            f.iCells.remove({rowIndx: b, colIndx: g}) : f.setSelection({
                rowIndx: b,
                colIndx: g
            }) : (this.mousedown = {r1: b, c1: g}, f.setSelection(null), f.setSelection({
            rowIndx: b,
            colIndx: g,
            setFirst: !0
        })), !0
    ...
    g._onCellMouseEnter = function (e, c) {
        ...
        if ("cell" == f.options.selectionModel.type && this.mousedown) {
            var b = this.mousedown, g = b.c1, a = c.rowIndx, d = c.colIndx;
            if (b.r1 != a || g != d) if (b.r2 != a || b.c2 != d) this.mousedown.r2 = a, this.mousedown.c2 = d, f.scrollCell({
                rowIndx: a,
                colIndx: d
            }), f.iCells.extendSelection({rowIndx: a, colIndx: d, evt: e})
        }
    };
    g._onRowMouseEnter = function (e, c) {
        ...
        if ("row" == f.options.selectionModel.type && this.mousedown) {
            var b = c.rowIndx;
            this.mousedown.r1 != b && this.mousedown.r2 != b && (this.mousedown.r2 = b, f.scrollRow({rowIndx: b}), f.iRows.extendSelection({
                rowIndx: b,
                evt: e
            }))
        }
    ...
    g._onRowMouseDown = function (e, c) {
        var f = this.that, b = c.rowIndx, g = f.options.selectionModel, a = g.mode;
        if ("row" == g.type && null != b) return e.shiftKey ? (f.iRows.extendSelection({
            rowIndx: b,
            evt: e
        }), e.preventDefault()) : (e.ctrlKey || e.metaKey) && "single" != a ? f.iRows.isSelected({rowIndx: b}) ?
            f.iRows.remove({rowIndx: b}) : f.setSelection({rowIndx: b}) : (this.mousedown = {
            r1: b,
            y1: e.pageY,
            x1: e.pageX
        }, f.setSelection(null), f.setSelection({rowIndx: b, setFirst: !0})), !0
    };
    g._onContMouseDown = function (e, c) {
        this.that.options.swipeModel.on && (this._stopSwipe(!0), this.swipedown = {x: e.pageX, y: e.pageY});
        return !0
    };
    ...
    g._onMouseStop = function (e, c) {
        ...
        if (this.swipedownPrev) {
            var g = b.options.swipeModel, b = this.swipedownPrev, a = b.ts, d = (new Date).getTime() - a, h = e.pageX,
                k = e.pageY, m = h - b.x, z = k - b.y;
            if (Math.sqrt(m * m + z * z) / d > g.ratio) {
                ...
                var r = function () {
                    v += g.speed;
                    s--;
                    f._onMouseDrag({pageX: h + v * m / d, pageY: k + v * z / d});
    ...
    g._onMouseDrag = function (e, c) {
        ...
        if (this.swipedown) {
            var b = this.swipedown, g = b.x, a = b.y, d = e.pageX, h = e.pageY;
            this.swipedownPrev = {x: g, y: a, ts: (new Date).getTime()};
    ...
    g.updateTableY = function (e) {
        if (0 == e) return !1;
        var c = this.that, f = this.getTableForVertScroll(), c = c.iRefresh.getEContHt();
        if (!f || !f.length) return !1;
        var b = f.data("offsetHeight") - 1, g = this.scrollTop -
            e;
    ...
    g.setScrollLeft = function (e, c, f) {
        0 <= e && (this.scrollLeft = e = Math.round(e), f && f.css({marginLeft: -1 * e}), c && c.parent("div").scrollLeft(e))
    };
    ...
    g.scrollHorSmooth = function (e, c) {
        if (e != c) {
            var f = this.that,
                b = c - e, g = this.getTableForHorScroll(), a = this.getTableHeaderForHorScroll(),
                f = f.iRefresh.getEContWd();
            if (g || a) {
                var d = (g ? g : a).data("scrollWidth"), b = this.scrollLeft - b;
    ...
    g.syncViewWithScrollBarVert = function (e) {
        if (null != e) {
            var c = this.that, f = this.getTableForVertScroll();
            if (f && f.length) {
                var b = c.options;
                b.editModel.indices && c.blurEditor({force: !0});
                var g = f.data("offsetHeight") - 1, c = c.iRefresh.getEContHt();
                e *= g - c;
    ...
    g.syncViewWithScrollBarHor = function (e) {
        if (null != e) {
            var c = this.that, f = this.getTableForHorScroll(), b = this.getTableHeaderForHorScroll();
            if (f || b) {
                c.options.editModel.indices && c.blurEditor({force: !0});
                var g = (f ? f : b).data("scrollWidth"), c = c.iRefresh.getEContWd();
                e *= g - c;
    ...
    g.syncHeaderViewWithScrollBarHor = function (e) {
        if (null != e) {
            var c = this.that, f = this.getTableHeaderForHorScroll();
            if (f) {
                var b = c.options, g = b.freezeCols;
                b.editModel.indices && c.blurEditor({force: !0});
                var b = f.data("scrollWidth"), a = c.iRefresh.getEContWd();
                e = m.call(c, g, e + g);
    ...
    g.syncScrollBarVert = function () {
        var e = this.that, c = this.getTableForVertScroll();
        if (c && c.length) {
            var c = c.data("offsetHeight"), f = e.iRefresh.getEContHt(), c = this.scrollTop / (c - f);
            0 <= c && 1 >= c && e.$vscroll.hasClass("pq-sb-vert") && e.$vscroll.pqScrollBar("option", "ratio", c)
        }
    };
    g.syncScrollBarHor = function () {
        var e = this.that,
            c = this.getTableForHorScroll(), f = this.getTableHeaderForHorScroll();
    ...
    g.scrollRowNonVirtual = function (e) {
        var c = this.that, f = c.options, b = e.rowIndxPage, g = e.rowIndx;
        e = c.iRefresh.getEContHt();
        b = null == b ? g - c.rowIndxOffset : b;
        f = parseInt(f.freezeRows);
        if (!(b < f) && (f = c.get$Tbl(b), g = c.getRow({rowIndxPage: b})[0])) {
            var c =
                g.offsetHeight, b = this.getScrollTop(), g = g.offsetTop, a = parseInt(f.css("marginTop"));
    ...
    g.scrollColumnNonVirtual = function (e) {
        var c = this.that, f = e.colIndx, f = null == f ? c.getColIndx({dataIndx: e.dataIndx}) : f,
            b = c.options.freezeCols;
        if (!(f < b)) {
            e = c._calcRightEdgeCol(f).width;
            var f = c._calcRightEdgeCol(f - 1).width, b = c._calcRightEdgeCol(b - 1).width,
                g = this.getTableForHorScroll(), a = this.getTableHeaderForHorScroll(),
                c = c.iRefresh.getEContWd(), d = this.scrollLeft;
            e - d > c ? (this.setScrollLeft(e - c, g, a), this.syncScrollBarHor()) : f - b < d && (this.setScrollLeft(f - b, g, a), this.syncScrollBarHor())
        }
    }
})(jQuery);
(function (k) {
    var h = null, m = !1, g = "", e = k.paramquery.pqGrid.prototype, c = e.options,
        f = {on: !0, header: !0, zIndex: 1E4},
        b = {on: !0, compare: "byVal", select: !0, validate: !0, allowInvalid: !0, type: "replace"};
    e.copy = function () {
        h = new l(this);
        h.copy();
        h = null
    ...
    var l = function (a, b) {
        var c;
        this.that = a;
        b && b.hasClass("pq-grid-row") ? (this.rowIndx = a.getRowIndx({$tr: b}).rowIndx, this.dataIndx = null) : b && b.hasClass("pq-grid-cell") ?
            (c = a.getCellIndices({$td: b}), this.rowIndx = c.rowIndx, this.dataIndx = c.dataIndx) : this.dataIndx = this.rowIndx = null
    }, e = l.prototype;
    e.createClipBoard = function () {
        var a = k("#pq-grid-excel-div"), a = this.that.options.copyModel, b = k("#pq-grid-excel");
    ...
    e.destroyClipBoard = function () {
        var a = this.that, b, c = a.iCells.getFocusSelection({old: !0});
        c ? b = a.getCell({
            rowIndx: c.rowIndx,
            dataIndx: c.dataIndx
        }) : (c = a.iRows.getFocusSelection({old: !0})) && (b = a.getRow({rowIndx: c.rowIndx}));
        var c = k(window).scrollTop(), e = k(window).scrollLeft();
    ...
    e.copy = function () {
        var a =
            k("#pq-grid-excel"), b = this.that, c = b.colModel, e = c.length, f = [], h = [];
    ...
    e.paste = function () {
        var a = this.that, b = k("#pq-grid-excel"), c = b.length ? b.val() : g, c = c.replace(/\n$/, ""),
            b = c.split("\n"), e = b.length, f, h = a.colModel, l = a.options.pasteModel, m = "row", r = h.length;
        if (l.on && 0 != c.length && 0 != e) {
            c = {rows: b};
            if (!1 === a._trigger("beforePaste", null, c)) return !1;
            var c = l.type, x, p, q, t, w = a.iRows.getSelectionCurPage();
            w && w.length || (m = "cell", w = a.iCells.getSelectionCurPage());
            w && w.length ? (x = w[0].rowIndx, q = w[w.length - 1].rowIndx, "cell" == m && (p =
                a.getColIndx({dataIndx: w[0].dataIndx}), t = a.getColIndx({dataIndx: w[w.length - 1].dataIndx}))) : t = p = q = x = 0;
            var y, u;
            ...
            for (var w = [], D = e = 0; D < x; D++) {
                var E = b[q], G = D + y, I = "replace" == c ? a.getRowData({rowIndx: G}) : null, H = I ? {} : null,
                    F = {};
                ...
                C = f;
                for (Q = 0; Q < C; Q++) {
                    var O = h[Q + p], R = M[J], K = O.dataIndx;
            ...
            c = {rowList: w, source: "paste", allowInvalid: l.allowInvalid, validate: l.validate};
            a._digestData(c);
            l.select && ("cell" == m ? a.iCells.selectBlock({
                initRowIndx: y,
                finalRowIndx: y + e - 1, initColIndx: p, finalColIndx: "extend" == A ? p + f - 1 + E : t
            }) : a.iRows.selectRange({initRowIndx: y, finalRowIndx: y + e - 1}));
            a.refreshView();
            c = {rows: b};
...
(function (k) {
    var h = k.paramquery.pqGrid.prototype.options,
        m = {on: !0, checkEditable: !0, checkEditableAdd: !1, allowInvalid: !0};
    ...
    h = (k.paramquery.cHistory = function (g) {
        ...
        var c = g.eventNamespace, f = g.widgetEventPrefix.toLowerCase();
    ...
    h.reset = function () {
        ...
        this.that._trigger("history",
            null, {num_undo: 0, num_redo: 0, type: "reset", canUndo: !1, canRedo: !1})
    };
    h.increment = function () {
        var g = this.records, e = g.length;
        this.id = e ? g[e - 1].id + 1 : 0
    };
    h.push = function (g) {
        var e = this.canRedo(), c = this.records, f = this.counter;
        c.length > f && c.splice(f, c.length - f);
        c[f] = k.extend({id: this.id}, g);
        this.counter++;
        g = this.that;
        var b, h;
        1 == this.counter && (b = !0);
        e && this.counter == c.length && (h = !1);
        g._trigger("history", null, {type: "add", canUndo: b, canRedo: h, num_undo: this.counter, num_redo: 0})
    };
    h.canUndo = function () {
    ...
    h.undo = function () {
        var g = this.canRedo(), e = this.that, c = this.options.historyModel, f = this.records;
        if (0 < this.counter) this.counter--; else return !1;
        for (var f = f[this.counter].rowList, b = [], h = 0, a = f.length; h < a; h++) {
            var d = f[h], k = d.newRow, m = d.rowData, B = d.type, z = d.oldRow, d = d.rowIndx;
            "update" == B ? (d = e.getRowIndx({rowData: m}).rowIndx, b.push({
                type: B,
                rowIndx: d,
                rowData: m,
                oldRow: k,
                newRow: z
            })) : "add" == B ? b.push({type: "delete", rowData: k}) : "delete" ==
                B && b.push({type: "add", rowIndx: d, newRow: m})
        }
        e._digestData({
            history: !1,
            source: "undo",
    ...
    h.redo = function () {
        var g = this.canUndo(), e = this.that, c = this.options.historyModel, f = this.counter, b = this.records;
        if (f ==
            b.length) return !1;
        for (var f = b[f].rowList, h = [], a = 0, d = f.length; a < d; a++) {
            var k = f[a], m = k.newRow, B = k.rowData, z = k.type, v = k.oldRow, k = k.rowIndx;
            "update" == z ? (k = e.getRowIndx({rowData: B}).rowIndx, h.push({
                type: z,
                rowIndx: k,
                rowData: B,
                oldRow: v,
                newRow: m
            })) : "add" == z ? h.push({type: "add", rowIndx: k, newRow: m}) : "delete" == z && h.push({
                type: "delete",
                rowData: B
            })
        }
...
(function (k) {
    var h = k.ui.autocomplete.prototype, m = h._renderMenu, g = h._renderItem;
    h._renderMenu = function (e, c) {
        m.call(this, e, c);
        var f = this.options.selectItem;
        if (f && f.on) {
            var f = f.cls, f = void 0 === f ? "ui-state-highlight" : f, b = this.element.val();
    ...
    h._renderItem = function (e, c) {
        var f = g.call(this, e, c), b = this.options.highlightText;
        if (b && b.on) {
            var h = this.element.val();
            if (h) {
                var h = new RegExp("(" + h + ")", "i"), a = c.label;
                if (h.test(a)) {
                    var d = b.style,
                        b = b.cls,
    ...
    k.widget("paramquery.pqTooltip", k.ui.tooltip, {
        options: {
            ...
            content: function () {
                var e = k(this), c = e.closest(".pq-grid").pqGrid("getInstance").grid, f = c.getCellIndices({$td: e});
                return (c = c.data({
                    rowIndx: f.rowIndx,
                    dataIndx: f.dataIndx,
                    data: "pq_valid"
            ...
            this._super();
            var e = this.element, c = this.eventNamespace;
            e.on("pqtooltipopen" + c, function (c, b) {
                var e = k(c.target), a = k(c.originalEvent.target);
                a.on("remove", function (a) {
                    e.pqTooltip("close", a, !0)
                });
                b.tooltip.css("zIndex", a.zIndex() + 5);
                if (e.is(".pq-grid")) {
                    var d = e.pqGrid("getCellIndices", {$td: a}), g = d.dataIndx, h;
                    (h = e.pqGrid("getRowData", {rowIndx: d.rowIndx})) && (h = h.pq_celldata) && (h = h[g]) && (h = h.pq_valid) &&
